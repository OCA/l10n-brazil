...
class InformacoesBeneficioRendimentoExterior(models.Model):

    _name = 'reinf.inf_beneficio_rendimento'
    _description = 'Informações sobre os beneficiários de Rendimentos no Exterior'
    _sql_constraints = [
        ('codigo',
         'unique(codigo)',
