...
class AccountInvoiceLine(models.Model):
    ...
    sped_documento_item_id = fields.Many2one('sped.documento.item', 'Item do Documento Fiscal', ondelete='cascade')
    is_brazilian_invoice = fields.Boolean('Is a Brazilian Invoice?', related='invoice_id.is_brazilian_invoice')
