...
Este módulo contém toda a estrutura dos registros da ECF do SPED. Ou
...
Odoo é hoje um trabalho e em andamento extremamente superficial no caso
da ECF**. Foi colocado o módulo no repo da localização para facilitar as
contribuições mas é importante vocẽ homologar bem até que ponto os
mapeamentos atuais atendem você. Se você quiser se destacar e virar
co-autor deste módulo, suas contribuições com mapeamentos estão muito
bem vindas.
