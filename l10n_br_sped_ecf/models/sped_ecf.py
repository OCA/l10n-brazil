...
class Registro9100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.9.9100"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "NOM_REGRA": 0,  # Identificação da regra.
    #         "MSG_REGRA": 0,  # Mensagem: Mensagem associada ao aviso.
    #         "REGISTRO": 0,  # Registro: Registro onde ocorreu o aviso.
    #         "CAMPO": 0,  # Campo: Nome do campo no registro onde ocorreu.
    #         "CONTEUDO": 0,  # Conteúdo: Conteúdo do campo – Valor preenchido pelo...
    #         "VALOR_ESPERADO": 0,  # Valor Original ou Calculado: Valor original o...
    #         "PER_APUR": 0,  # Período de Apuração Fiscal.
    #         "COD_CTA": 0,  # Código da Conta.
    #         "COD_CCUS": 0,  # Centro de Custos.
    #         "COD_CTA_REF": 0,  # Código da Conta Referencial.
    #         "CODIGO": 0,  # Código da linha na tabela dinâmica.
    #         "NUM_ORDEM": 0,  # Número de Ordem (X300)
    #         "CNPJ_ESTAB": 0,  # CNPJ do Estabelecimento (Y540).
    #         "CNAE": 0,  # CNAE (Y540)
    #         "COD_CTA_B": 0,  # Código da Conta da Parte B.
    #         "COD_TRIBUTO": 0,  # Tributo Relacionado à Conta da Parte B.
    #     }
...
class Registro9900(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.9.9900"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "REG_BLC": 0,  # Registro: Registro que será totalizado em 9900.QTD_R...
    #         "QTD_REG_BLC": 0,  # Total de Registros por Tipo: Total de registros ...
    #         "VERSAO": 0,  # Versão: Versão da tabela dinâmica utilizada. Será pre...
    #         "ID_TAB_DIN": 0,  # Identificação da Tabela Dinâmica Utilizada.
    #     }
