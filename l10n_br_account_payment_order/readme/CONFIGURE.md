...
Crie uma **Configuração CNAB**, é onde será armazenada as informações específicas de cada caso como a Carteira, Convênio, Código do Beneficiário, Códigos de Instrução e Retorno do Movimento, etc em:
