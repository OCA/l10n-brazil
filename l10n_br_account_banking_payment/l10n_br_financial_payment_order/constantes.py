...
TIPOS_ORDEM_PAGAMENTO = [
    ('payment', u'Pagamento'),
    ('pagamento_folha', u'Pagamento Folha'),
    ('cobranca', u'Cobrança / Boleto'),
    ('debit', u'Débito'),
]

ORIGEM_PAGAMENTO = [
    ('receber', u'Contas a Receber'),
    ('pagar', u'Contas a Pagar'),
    ('folha_salario', u'Folha de Pagamento - Salario'),
    ('folha_pensao', u'Folha de Pagamento - Pensão'),
]
