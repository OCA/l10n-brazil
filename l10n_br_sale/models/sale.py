...
class SaleOrder(models.Model):
    ...
    def _amount_all(self):
        for order in self:
            ...
            amount_tax = amount_untaxed = amount_discount = amount_gross = 0.0
    ...
    cnpj_cpf = fields.Char(string=u"CNPJ/CPF", related="partner_id.cnpj_cpf")
    legal_name = fields.Char(string=u"Razão Social", related="partner_id.legal_name")
    ie = fields.Char(string=u"Inscrição Estadual", related="partner_id.inscr_est")
    ...
    def onchange_fiscal(self):
        ...
        for record in self:
            if record.company_id and record.partner_id and record.fiscal_category_id:
                kwargs = {
    ...
    def _fiscal_comment(self, order):
        ...
        for line in order.order_line:
            if (
                ...
                and line.fiscal_position_id.inv_copy_note
                and line.fiscal_position_id.note
            ):
    ...
    def _prepare_invoice(self):
        ...
        if (
            ...
            and self.order_line
            and self.order_line[0].fiscal_category_id
        ):
