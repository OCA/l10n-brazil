...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:e50ba3e6afd273fef9116932a3325e9bbaeda940247fd7d637821c3559676d58
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
-  Caso o Código de Retorno CNAB recebido seja um dos "Códigos de
   ...
   valor_desconto + valor_abatimento) - valor_juros_mora
-  Quando marcada a opção de "Reconciliação Automatica" /a Entrada de
   ...
   o arquivo, se não estiver marcada isso deverá ser feito manualmente.
...
-  CNAB changes such as Change Due Date, Protest, Grant Rebate, etc. can
   ...
   selected CNAB Movement Instruction.
...
-  Incluir a posssibilidade de imprimir o boleto no menu Imprimir da
   ...
   um QWeb, verificar na migração para outras versões.
