...
class TrespTec(models.AbstractModel):
    ...
    _name = "cteos.40.tresptec"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TrespTec"


    
    cteos40_CNPJ = fields.Char(
        string="CNPJ",
        xsd_required=True,
        xsd_type="TCnpj",
        help=(
    ...
    cteos40_email = fields.Char(
        string="Email da pessoa jurídica a ser contatada",
        xsd_required=True,
        xsd_type="TEmail"
    )
    
    cteos40_fone = fields.Char(
...
class TendOrg(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tendorg"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TendOrg"


    
    cteos40_xLgr = fields.Char(
        string="Logradouro",
        xsd_required=True
    )
    
    cteos40_nro = fields.Char(
        string="Número",
        xsd_required=True
    )
    
    cteos40_xCpl = fields.Char(
        string="Complemento"
    )
    
    cteos40_xBairro = fields.Char(
        string="Bairro",
        xsd_required=True
    )
    
    cteos40_cMun = fields.Char(
    ...
    cteos40_CEP = fields.Char(
        string="CEP"
    )
    
    cteos40_UF = fields.Selection(TUF,
        string="Sigla da UF",
        xsd_required=True,
        xsd_type="TUf",
    ...
    cteos40_cPais = fields.Char(
        string="Código do país"
    )
    
    cteos40_xPais = fields.Char(
        string="Nome do país"
    )
...
class TendeEmi(models.AbstractModel):
    ...
    cteos40_UF = fields.Selection(TUF_SEM_EX,
        string="Sigla da UF",
        xsd_required=True,
        xsd_type="TUF_sem_EX"
    )
...
class TprotCte(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotcte"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TprotCte"


    
    cteos40_infProt = fields.Many2one(
        comodel_name="cteos.40.tprotcte_infprot",
        string="Dados do protocolo de status",
        xsd_required=True
    )
    
    cteos40_infFisco = fields.Many2one(
        comodel_name="cteos.40.tprotcte_inffisco",
        string="Mensagem do Fisco"
    )
    
    cteos40_versao = fields.Char(
        string="versao",
        xsd_required=True
    )
...
class TprotCteInfProt(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotcte_infprot"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TprotCte.InfProt"


    
    cteos40_tpAmb = fields.Selection(TAMB,
    ...
    cteos40_chCTe = fields.Char(
        string="Chaves de acesso da CT-e",
        xsd_required=True,
        xsd_type="TChDFe"
    )
    
    cteos40_dhRecbto = fields.Datetime(
    ...
    cteos40_nProt = fields.Char(
        string="Número do Protocolo de Status do CT-e",
        xsd_type="TProt"
    )
    
    cteos40_digVal = fields.Char(
    ...
    cteos40_cStat = fields.Char(
        string="Código do status do CT-e",
        xsd_required=True
    )
    
    cteos40_xMotivo = fields.Char(
...
class TprotCteInfFisco(models.AbstractModel):
    "Mensagem do Fisco"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotcte_inffisco"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TprotCte.InfFisco"


    
    cteos40_cMsg = fields.Char(
        string="Código do status da mensagem do fisco",
        xsd_required=True
    )
    
    cteos40_xMsg = fields.Char(
        string="Mensagem do Fisco",
        xsd_required=True,
        xsd_type="TMotivo"
    )
...
class TprotCteOs(models.AbstractModel):
    ...
    cteos40_infProt = fields.Many2one(
        comodel_name="cteos.40.tprotcteos_infprot",
        string="Dados do protocolo de status",
        xsd_required=True
    )
    
    cteos40_infFisco = fields.Many2one(
        comodel_name="cteos.40.tprotcteos_inffisco",
        string="Mensagem do Fisco"
    )
...
class TprotCteOsInfProt(models.AbstractModel):
    "Dados do protocolo de status"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotcteos_infprot"
    _inherit = "spec.mixin.cteos"
...
class TprotCteOsInfFisco(models.AbstractModel):
    "Mensagem do Fisco"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotcteos_inffisco"
    _inherit = "spec.mixin.cteos"
...
class TprotGtve(models.AbstractModel):
    ...
    cteos40_infProt = fields.Many2one(
        comodel_name="cteos.40.tprotgtve_infprot",
        string="Dados do protocolo de status",
        xsd_required=True
    )
    
    cteos40_infFisco = fields.Many2one(
        comodel_name="cteos.40.tprotgtve_inffisco",
        string="Mensagem do Fisco"
    )
...
class TprotGtveInfProt(models.AbstractModel):
    "Dados do protocolo de status"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotgtve_infprot"
    _inherit = "spec.mixin.cteos"
    ...
    cteos40_nProt = fields.Char(
        string="Número do Protocolo de Status da GTV-e",
        xsd_type="TProt"
    )
    ...
    cteos40_cStat = fields.Char(
        string="Código do status da GTV-e",
        xsd_required=True
    )
...
class TprotGtveInfFisco(models.AbstractModel):
    "Mensagem do Fisco"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tprotgtve_inffisco"
    _inherit = "spec.mixin.cteos"
...
class TunidCarga(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tunidcarga"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TunidCarga"


    cteos40_infUnidCarga_infNFe_id = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infnfe",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_infUnidCarga_infNF_id = fields.Many2one(
        comodel_name="cteos.40.infnf",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_infUnidCarga_infNFe_id = fields.Many2one(
        comodel_name="cteos.40.tcte_infnfe",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_infUnidCarga_infOutros_id = fields.Many2one(
        comodel_name="cteos.40.infoutros",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_infUnidCarga_TUnidadeTransp_id = fields.Many2one(
        comodel_name="cteos.40.tunidadetransp",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_tpUnidCarga = fields.Selection(TTIPOUNIDCARGA,
    ...
    cteos40_idUnidCarga = fields.Char(
    ...
    cteos40_lacUnidCarga = fields.One2many("cteos.40.lacunidcarga", "cteos40_lacUnidCarga_TUnidCarga_id",
        string="Lacres das Unidades de Carga"
    )
    
    cteos40_qtdRat = fields.Monetary(
...
class LacUnidCarga(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.lacunidcarga"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TunidCarga.LacUnidCarga"


    cteos40_lacUnidCarga_TUnidCarga_id = fields.Many2one(
        comodel_name="cteos.40.tunidcarga",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_nLacre = fields.Char(
        string="Número do lacre",
        xsd_required=True
    )
...
class TcteOs(models.AbstractModel):
    ...
    67)"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs"


    
    cteos40_infCte = fields.Many2one(
        comodel_name="cteos.40.tcteos_infcte",
        string="Informações do CT-e Outros Serviços",
        xsd_required=True
    )
    
    cteos40_infCTeSupl = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctesupl",
...
class TcteOsInfCte(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infcte"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte"


    
    cteos40_ide = fields.Many2one(
        comodel_name="cteos.40.tcteos_ide",
        string="Identificação do CT-e Outros Serviços",
        xsd_required=True
    )
    
    cteos40_compl = fields.Many2one(
        comodel_name="cteos.40.tcteos_compl",
        string="Dados complementares",
        help=(
    ...
    cteos40_vPrest = fields.Many2one(
        comodel_name="cteos.40.tcteos_vprest",
        string="Valores da Prestação de Serviço",
        xsd_required=True,
        xsd_type="TDec_1302"
    )
    
    cteos40_imp = fields.Many2one(
        comodel_name="cteos.40.tcteos_imp",
        string="Informações relativas aos Impostos",
        xsd_required=True
    )
    
    cteos40_infCTeNorm = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctenorm",
        string="Grupo de informações do CT-e OS Normal",
        choice="infcte",
        xsd_choice_required=True
    )
    
    cteos40_infCteComp = fields.One2many("cteos.40.tcteos_infctecomp", "cteos40_infCteComp_infCte_id",
        string="Detalhamento do CT-e complementado",
        choice="infcte",
        xsd_choice_required=True
    )
    
    cteos40_autXML = fields.One2many("cteos.40.tcteos_autxml", "cteos40_autXML_infCte_id",
    ...
    cteos40_infRespTec = fields.Many2one(
        comodel_name="cteos.40.tresptec",
        string="Informações",
        xsd_type="TRespTec",
...
class TcteOsIde(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_ide"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Ide"


    
    cteos40_cUF = fields.Selection(TCODUFIBGE,
    ...
    cteos40_CFOP = fields.Char(
        string="Código Fiscal de Operações e Prestações",
        xsd_required=True,
        xsd_type="TCfop"
    )
    
    cteos40_natOp = fields.Char(
        string="Natureza da Operação",
        xsd_required=True
    )
    
    cteos40_mod = fields.Selection(TMODCTOS,
    ...
    cteos40_serie = fields.Char(
        string="Série do CT-e OS",
        xsd_required=True,
        help="Série do CT-e OS\nPreencher com '0' no caso de série única"
    )
    
    cteos40_nCT = fields.Char(
        string="Número do CT-e OS",
        xsd_required=True,
        xsd_type="TNF"
    )
    
    cteos40_dhEmi = fields.Char(
    ...
    cteos40_tpImp = fields.Selection(IDE_TPIMP,
    ...
    cteos40_tpEmis = fields.Selection(IDE_TPEMIS_4,
    ...
    cteos40_tpCTe = fields.Selection(TFINCTE,
    ...
    cteos40_procEmi = fields.Selection(TPROCEMI,
    ...
    cteos40_UFEnv = fields.Selection(TUF,
    ...
    cteos40_modal = fields.Selection(TMODTRANSPOS,
    ...
    cteos40_tpServ = fields.Selection(IDE_TPSERV_4,
    ...
    cteos40_indIEToma = fields.Selection(IDE_INDIETOMA,
    ...
    cteos40_UFIni = fields.Selection(TUF,
    ...
    cteos40_cMunFim = fields.Char(
        string="Código (cMunFim)",
        xsd_type="TCodMunIBGE",
        help=(
    ...
    cteos40_UFFim = fields.Selection(TUF,
    ...
    cteos40_infPercurso = fields.One2many("cteos.40.infpercurso", "cteos40_infPercurso_ide_id",
        string="Informações do Percurso",
        help="Informações do Percurso do CT-e Outros Serviços"
    )
    
    cteos40_dhCont = fields.Datetime(
    ...
    cteos40_xJust = fields.Char(
        string="Justificativa da entrada em contingência"
    )
    
    cteos40_gCompraGov = fields.Many2one(
        comodel_name="cteos.40.tcompragovreduzido",
...
class InfPercurso(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infpercurso"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Ide.InfPercurso"


    cteos40_infPercurso_ide_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_ide",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_UFPer = fields.Selection(TUF,
...
class TcteOsCompl(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_compl"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Compl"


    
    cteos40_xCaracAd = fields.Char(
    ...
    cteos40_xEmi = fields.Char(
        string="Funcionário emissor do CTe"
    )
    
    cteos40_xObs = fields.Char(
        string="Observações Gerais"
    )
    
    cteos40_ObsCont = fields.One2many("cteos.40.tcteos_obscont", "cteos40_ObsCont_compl_id",
    ...
    cteos40_ObsFisco = fields.One2many("cteos.40.tcteos_obsfisco", "cteos40_ObsFisco_compl_id",
        string="ObsFisco",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
...
class TcteOsObsCont(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_obscont"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Compl.ObsCont"


    cteos40_ObsCont_compl_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_compl",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_xTexto = fields.Char(
        string="Conteúdo do campo",
        xsd_required=True
    )
    
    cteos40_xCampo = fields.Char(
        string="Identificação do campo",
        xsd_required=True
    )
...
class TcteOsObsFisco(models.AbstractModel):
    ...
    Informar o nome do campo no atributo xCampo e o conteúdo do campo no XTexto"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_obsfisco"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Compl.ObsFisco"


    cteos40_ObsFisco_compl_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_compl",
        xsd_implicit=True,
        ondelete="cascade"
    )
...
class TcteOsEmit(models.AbstractModel):
    ...
    cteos40_IE = fields.Char(
        string="Inscrição Estadual do Emitente",
        xsd_required=True
    )
    
    cteos40_IEST = fields.Char(
    ...
    cteos40_xFant = fields.Char(
        string="Nome fantasia"
    )
    
    cteos40_enderEmit = fields.Many2one(
        comodel_name="cteos.40.tendeemi",
        string="Endereço do emitente",
        xsd_required=True,
        xsd_type="TEndeEmi"
    )
    
    cteos40_CRT = fields.Selection(TCRT,
...
class TcteOsToma(models.AbstractModel):
    ...
    cteos40_enderToma = fields.Many2one(
        comodel_name="cteos.40.tendereco",
...
class TcteOsVPrest(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_vprest"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.VPrest"


    
    cteos40_vTPrest = fields.Monetary(
    ...
    cteos40_Comp = fields.One2many("cteos.40.tcteos_vprest_comp", "cteos40_Comp_vPrest_id",
...
class TcteOsVPrestComp(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_vprest_comp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.VPrest.Comp"


    cteos40_Comp_vPrest_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_vprest",
        xsd_implicit=True,
        ondelete="cascade"
    )
...
class TcteOsImp(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_imp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Imp"


    
    cteos40_ICMS = fields.Many2one(
        comodel_name="cteos.40.timpos",
        string="Informações relativas ao ICMS",
        xsd_required=True,
        xsd_type="TImp"
    )
    
    cteos40_vTotTrib = fields.Monetary(
        string="Valor Total dos Tributos",
        xsd_type="TDec_1302",
        currency_field="brl_currency_id"
    )
    
    cteos40_infAdFisco = fields.Char(
    ...
    cteos40_infTribFed = fields.Many2one(
        comodel_name="cteos.40.inftribfed",
    ...
    cteos40_IBSCBS = fields.Many2one(
        comodel_name="cteos.40.ttribcte",
        string="Grupo de informações do IBS e CBS",
        xsd_type="TTribCTe"
    )
    
    cteos40_vTotDFe = fields.Monetary(
...
class InfTribFed(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.inftribfed"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.Imp.InfTribFed"


    
    cteos40_vPIS = fields.Monetary(
        string="Valor do PIS",
        xsd_type="TDec_1302",
        currency_field="brl_currency_id"
    )
    
    cteos40_vCOFINS = fields.Monetary(
        string="Valor COFINS",
        xsd_type="TDec_1302",
        currency_field="brl_currency_id"
    )
    
    cteos40_vIR = fields.Monetary(
        string="Valor de Imposto de Renda",
        xsd_type="TDec_1302",
        currency_field="brl_currency_id"
    )
    
    cteos40_vINSS = fields.Monetary(
        string="Valor do INSS",
        xsd_type="TDec_1302",
        currency_field="brl_currency_id"
    )
    
    cteos40_vCSLL = fields.Monetary(
...
class TcteOsAutXml(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_autxml"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.AutXml"


    cteos40_autXML_infCte_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_infcte",
        xsd_implicit=True,
        ondelete="cascade"
    )
...
class TcteOsInfCteNorm(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infctenorm"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm"


    
    cteos40_infServico = fields.Many2one(
        comodel_name="cteos.40.infservico",
        string="Informações da Prestação do Serviço",
        xsd_required=True
    )
    
    cteos40_infDocRef = fields.One2many("cteos.40.infdocref", "cteos40_infDocRef_infCTeNorm_id",
        string="Informações dos documentos referenciados"
    )
    
    cteos40_seg = fields.One2many("cteos.40.seg", "cteos40_seg_infCTeNorm_id",
        string="Informações de Seguro da Carga"
    )
    
    cteos40_infModal = fields.Many2one(
        comodel_name="cteos.40.tcteos_infmodal",
        string="Informações do modal",
        help="Informações do modal\nObrigatório para Pessoas e Bagagem"
    )
    
    cteos40_infCteSub = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctesub",
        string="Informações do CT-e de substituição"
    )
    
    cteos40_refCTeCanc = fields.Char(
    ...
    cteos40_cobr = fields.Many2one(
        comodel_name="cteos.40.tcteos_cobr",
        string="Dados da cobrança do CT-e"
    )
    
    cteos40_infGTVe = fields.One2many("cteos.40.infgtve", "cteos40_infGTVe_infCTeNorm_id",
        string="infGTVe",
...
class InfServico(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infservico"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm.InfServico"


    
    cteos40_xDescServ = fields.Char(
        string="Descrição do Serviço prestado",
        xsd_required=True
    )
    
    cteos40_infQ = fields.Many2one(
        comodel_name="cteos.40.tcteos_infq",
...
class InfDocRef(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infdocref"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm.InfDocRef"


    cteos40_infDocRef_infCTeNorm_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctenorm",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_nDoc = fields.Char(
        string="Número",
        choice="infdocref",
        xsd_choice_required=True
    )
    ...
    cteos40_subserie = fields.Char(
        string="Subsérie",
        choice="infdocref",
        xsd_choice_required=True
    )
    
    cteos40_dEmi = fields.Date(
...
class Seg(models.AbstractModel):
    ...
    cteos40_seg_infCTeNorm_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctenorm",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_respSeg = fields.Selection(SEG_RESPSEG,
    ...
    cteos40_xSeg = fields.Char(
        string="Nome da Seguradora"
    )
    
    cteos40_nApol = fields.Char(
...
class TcteOsInfModal(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infmodal"
    _inherit = "spec.mixin.cteos"
    ...
    cteos40_versaoModal = fields.Char(
        string="Versão do leiaute específico para",
        xsd_required=True,
...
class TcteOsInfCteSub(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infctesub"
    _inherit = "spec.mixin.cteos"
...
class TcteOsCobr(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_cobr"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm.Cobr"


    
    cteos40_fat = fields.Many2one(
        comodel_name="cteos.40.tcteos_fat",
        string="Dados da fatura"
    )
    
    cteos40_dup = fields.One2many("cteos.40.tcteos_dup", "cteos40_dup_cobr_id",
...
class InfGtve(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infgtve"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm.InfGtve"


    cteos40_infGTVe_infCTeNorm_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_infctenorm",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chCTe = fields.Char(
        string="Chave de acesso da GTV-e",
        xsd_required=True
    )
    
    cteos40_Comp = fields.One2many("cteos.40.tcteos_infctenorm_comp", "cteos40_Comp_infGTVe_id",
...
class TcteOsInfCteNormComp(models.AbstractModel):
    "Componentes do Valor da Prestação"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infctenorm_comp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteNorm.InfGtve.Comp"


    cteos40_Comp_infGTVe_id = fields.Many2one(
        comodel_name="cteos.40.infgtve",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_tpComp = fields.Selection(COMP_TPCOMP,
...
class TcteOsInfCteComp(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infctecomp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCte.InfCteComp"


    cteos40_infCteComp_infCte_id = fields.Many2one(
        comodel_name="cteos.40.tcteos_infcte",
        xsd_implicit=True,
        ondelete="cascade"
    )
...
class TcteOsInfCteSupl(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcteos_infctesupl"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteOs.InfCteSupl"


    
    cteos40_qrCodCTe = fields.Char(
        string="Texto com o QR-Code impresso no DACTE",
        xsd_required=True
    )
...
class Tgtve(models.AbstractModel):
    ...
    cteos40_infCte = fields.Many2one(
        comodel_name="cteos.40.tgtve_infcte",
        string="Informações do CT-e do tipo GTV-e",
        xsd_required=True
    )
    
    cteos40_infCTeSupl = fields.Many2one(
        comodel_name="cteos.40.tgtve_infctesupl",
...
class TgtveInfCte(models.AbstractModel):
    ...
    cteos40_ide = fields.Many2one(
        comodel_name="cteos.40.tgtve_ide",
        string="Identificação da GTV-e",
        xsd_required=True
    )
    
    cteos40_compl = fields.Many2one(
        comodel_name="cteos.40.tgtve_compl",
        string="compl",
        help=(
    ...
    cteos40_emit = fields.Many2one(
        comodel_name="cteos.40.tgtve_emit",
        string="Identificação do Emitente da GTV-e",
        xsd_required=True
    )
    
    cteos40_rem = fields.Many2one(
        comodel_name="cteos.40.tgtve_rem",
    ...
    cteos40_dest = fields.Many2one(
        comodel_name="cteos.40.tgtve_dest",
    ...
    cteos40_origem = fields.Many2one(
        comodel_name="cteos.40.tendeemi",
    ...
    cteos40_destino = fields.Many2one(
        comodel_name="cteos.40.tendeemi",
    ...
    cteos40_detGTV = fields.Many2one(
        comodel_name="cteos.40.detgtv",
        string="Grupo de informações detalhadas da GTV-e",
        xsd_required=True
    )
    
    cteos40_autXML = fields.One2many("cteos.40.tgtve_autxml", "cteos40_autXML_infCte_id",
        string="Autorizados para download do XML do DF-e",
        help=(
            "Autorizados para download do XML do DF-e\nInformar CNPJ ou CPF. "
            "Preencher os zeros não significativos."
...
class TgtveIde(models.AbstractModel):
    ...
    cteos40_mod = fields.Selection(TMODGTVE,
        string="Modelo do documento fiscal",
        xsd_required=True,
        xsd_type="TModGTVe",
        help=(
    ...
    cteos40_tpEmis = fields.Selection(IDE_TPEMIS_1,
    ...
    cteos40_tpCTe = fields.Selection(TFINGTVE,
    ...
    cteos40_modal = fields.Selection(IDE_MODAL,
    ...
    cteos40_tpServ = fields.Selection(IDE_TPSERV_1,
        string="Tipo do Serviço",
        xsd_required=True,
    ...
    cteos40_dhSaidaOrig = fields.Char(
    ...
    cteos40_dhChegadaDest = fields.Char(
    ...
    cteos40_toma = fields.Many2one(
        comodel_name="cteos.40.tgtve_toma",
    ...
    cteos40_tomaTerceiro = fields.Many2one(
        comodel_name="cteos.40.tomaterceiro",
        string="tomaTerceiro",
        choice="ide",
        xsd_choice_required=True,
...
class TgtveToma(models.AbstractModel):
    """Indicador do "papel" do tomador do serviço no GT-e"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tgtve_toma"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tgtve.InfCte.Ide.Toma"


    
    cteos40_toma = fields.Selection(TOMA_TOMA_1,
...
class TomaTerceiro(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tomaterceiro"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tgtve.InfCte.Ide.TomaTerceiro"


    
    cteos40_toma = fields.Selection(TOMATERCEIRO_TOMA,
        string="Tomador do Serviço",
        xsd_required=True,
        help=(
            "Tomador do Serviço\nPreencher com: \n               4 - Outros\n"
...
class TgtveCompl(models.AbstractModel):
    ...
    cteos40_xEmi = fields.Char(
        string="Funcionário emissor da GTV-e"
    )
    ...
    cteos40_ObsCont = fields.One2many("cteos.40.tgtve_obscont", "cteos40_ObsCont_compl_id",
        string="Campo de uso livre do contribuinte",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
    ...
    cteos40_ObsFisco = fields.One2many("cteos.40.tgtve_obsfisco", "cteos40_ObsFisco_compl_id",
        string="ObsFisco",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
...
class TgtveRem(models.AbstractModel):
    ...
    cteos40_enderReme = fields.Many2one(
        comodel_name="cteos.40.tendereco",
        string="Dados do endereço",
        xsd_required=True,
        xsd_type="TEndereco"
...
class TgtveDest(models.AbstractModel):
    ...
    cteos40_enderDest = fields.Many2one(
        comodel_name="cteos.40.tendereco",
        string="Dados do endereço",
        xsd_required=True,
        xsd_type="TEndereco"
...
class DetGtv(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.detgtv"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tgtve.InfCte.DetGtv"


    
    cteos40_infEspecie = fields.One2many("cteos.40.infespecie", "cteos40_infEspecie_detGTV_id",
    ...
    cteos40_infVeiculo = fields.One2many("cteos.40.infveiculo", "cteos40_infVeiculo_detGTV_id",
        string="infVeiculo",
        help=(
...
class InfEspecie(models.AbstractModel):
    "Informações das Espécies transportadas"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infespecie"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tgtve.InfCte.DetGtv.InfEspecie"


    cteos40_infEspecie_detGTV_id = fields.Many2one(
        comodel_name="cteos.40.detgtv",
        xsd_implicit=True,
        ondelete="cascade"
    )
    
    cteos40_vEspecie = fields.Monetary(
    ...
    cteos40_tpNumerario = fields.Selection(INFESPECIE_TPNUMERARIO,
        string="Nacionalidade do Numerário",
        xsd_required=True,
        help="Nacionalidade do Numerário\n1 - Nacional\n2 - Estrangeiro"
    )
    
    cteos40_xMoedaEstr = fields.Char(
...
class InfVeiculo(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infveiculo"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tgtve.InfCte.DetGtv.InfVeiculo"


    cteos40_infVeiculo_detGTV_id = fields.Many2one(
        comodel_name="cteos.40.detgtv",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_placa = fields.Char(
    ...
    cteos40_RNTRC = fields.Char(
        string="RNTRC do transportador"
    )
...
class TgtveInfCteSupl(models.AbstractModel):
    "Informações suplementares da GTV-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tgtve_infctesupl"
    _inherit = "spec.mixin.cteos"
...
class TretCte(models.AbstractModel):
    ...
    cteos40_protCTe = fields.Many2one(
        comodel_name="cteos.40.tprotcte",
...
class TretCteOs(models.AbstractModel):
    ...
    cteos40_protCTe = fields.Many2one(
        comodel_name="cteos.40.tprotcteos",
        string="Reposta ao processamento do CT-e",
        xsd_type="TProtCTeOS"
    )
...
class TretGtve(models.AbstractModel):
    ...
    cteos40_protCTe = fields.Many2one(
        comodel_name="cteos.40.tprotgtve",
        string="Reposta ao processamento do CT-e",
        xsd_type="TProtGTVe"
    )
...
class TunidadeTransp(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tunidadetransp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TunidadeTransp"


    cteos40_infUnidTransp_infNFe_id = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infnfe",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_infUnidTransp_infNF_id = fields.Many2one(
        comodel_name="cteos.40.infnf",
        xsd_implicit=True,
        ondelete="cascade"
    )
    ...
    cteos40_infUnidTransp_infOutros_id = fields.Many2one(
        comodel_name="cteos.40.infoutros",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_tpUnidTransp = fields.Selection(TTIPOUNIDTRANSP,
    ...
    cteos40_idUnidTransp = fields.Char(
    ...
    cteos40_lacUnidTransp = fields.One2many("cteos.40.lacunidtransp", "cteos40_lacUnidTransp_TUnidadeTransp_id",
        string="Lacres das Unidades de Transporte"
    )
    
    cteos40_infUnidCarga = fields.One2many("cteos.40.tunidcarga", "cteos40_infUnidCarga_TUnidadeTransp_id",
...
class LacUnidTransp(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.lacunidtransp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TunidadeTransp.LacUnidTransp"


    cteos40_lacUnidTransp_TUnidadeTransp_id = fields.Many2one(
        comodel_name="cteos.40.tunidadetransp",
        xsd_implicit=True,
        ondelete="cascade"
    )
...
class Tcte(models.AbstractModel):
    ...
    cteos40_infCte = fields.Many2one(
        comodel_name="cteos.40.tcte_infcte",
        string="Informações do CT-e",
        xsd_required=True
    )
    
    cteos40_infCTeSupl = fields.Many2one(
        comodel_name="cteos.40.tcte_infctesupl",
        string="Informações suplementares do CT-e"
    )
...
class TcteInfCte(models.AbstractModel):
    ...
    cteos40_ide = fields.Many2one(
        comodel_name="cteos.40.tcte_ide",
        string="Identificação do CT-e",
        xsd_required=True
    )
    
    cteos40_compl = fields.Many2one(
        comodel_name="cteos.40.tcte_compl",
        string="Dados complementares",
        help=(
            "Dados complementares do CT-e para fins operacionais ou comerciais"
        )
    ...
    cteos40_emit = fields.Many2one(
        comodel_name="cteos.40.tcte_emit",
        string="Identificação do Emitente do CT-e",
        xsd_required=True
    )
    
    cteos40_rem = fields.Many2one(
        comodel_name="cteos.40.tcte_rem",
        string="Informações",
        help=(
    ...
    cteos40_exped = fields.Many2one(
        comodel_name="cteos.40.exped",
        string="Informações do Expedidor da Carga"
    )
    
    cteos40_receb = fields.Many2one(
        comodel_name="cteos.40.receb",
        string="Informações do Recebedor da Carga"
    )
    
    cteos40_dest = fields.Many2one(
        comodel_name="cteos.40.tcte_dest",
    ...
    cteos40_vPrest = fields.Many2one(
        comodel_name="cteos.40.tcte_vprest",
        string="Valores da Prestação de Serviço",
        xsd_required=True,
        xsd_type="TDec_1302"
    )
    ...
    cteos40_imp = fields.Many2one(
        comodel_name="cteos.40.tcte_imp",
        string="Informações relativas aos Impostos",
        xsd_required=True
    )
    
    cteos40_infCTeNorm = fields.Many2one(
        comodel_name="cteos.40.tcte_infctenorm",
    ...
    cteos40_infCteComp = fields.One2many("cteos.40.tcte_infctecomp", "cteos40_infCteComp_infCte_id",
        string="Detalhamento do CT-e complementado",
        choice="infcte",
        xsd_choice_required=True
    )
    
    cteos40_autXML = fields.One2many("cteos.40.tcte_autxml", "cteos40_autXML_infCte_id",
        string="Autorizados para download do XML do DF-e",
        help=(
            "Autorizados para download do XML do DF-e\nInformar CNPJ ou CPF. "
            "Preencher os zeros não significativos."
    ...
    cteos40_infRespTec = fields.Many2one(
        comodel_name="cteos.40.tresptec",
        string="Informações (infRespTec)",
        xsd_type="TRespTec",
        help="Informações do Responsável Técnico pela emissão do DF-e"
    )
    
    cteos40_infSolicNFF = fields.Many2one(
        comodel_name="cteos.40.tcte_infsolicnff",
        string="Grupo de informações (infSolicNFF)",
        help=(
            "Grupo de informações do pedido de emissão da Nota Fiscal Fácil"
        )
    )
    
    cteos40_infPAA = fields.Many2one(
        comodel_name="cteos.40.tcte_infpaa",
...
class TcteIde(models.AbstractModel):
    ...
    cteos40_mod = fields.Selection(TMODCT,
        string="Modelo do documento fiscal",
        xsd_required=True,
        xsd_type="TModGTVe",
        help=(
    ...
    cteos40_tpEmis = fields.Selection(IDE_TPEMIS_3,
        string="Forma de emissão do CT-e",
        xsd_required=True,
        help=(
            "Forma de emissão do CT-e\nPreencher com:\n1 - Normal;\n 3-Regime "
    ...
    cteos40_indGlobalizado = fields.Selection(IDE_INDGLOBALIZADO,
    ...
    cteos40_modal = fields.Selection(TMODTRANSP,
        string="Modal",
        xsd_required=True,
        help=(
    ...
    cteos40_tpServ = fields.Selection(IDE_TPSERV_3,
        string="Tipo do Serviço",
        xsd_required=True,
        help=(
            "Tipo do Serviço\nPreencher com: \n0 - Normal;\n1 - "
    ...
    cteos40_retira = fields.Selection(IDE_RETIRA,
    ...
    cteos40_xDetRetira = fields.Char(
        string="Detalhes do retira"
    )
    
    cteos40_indIEToma = fields.Selection(IDE_INDIETOMA,
        string="Indicador do papel",
        xsd_required=True,
        help=(
            "Indicador do papel do tomador na prestação do serviço:\n1 – "
            "Contribuinte ICMS;\n2 – Contribuinte isento de inscrição;\n9 – "
    ...
    cteos40_toma3 = fields.Many2one(
        comodel_name="cteos.40.toma3",
        string="Indicador do 'papel' do tomador",
        choice="ide",
        xsd_choice_required=True,
    ...
    cteos40_toma4 = fields.Many2one(
        comodel_name="cteos.40.toma4",
...
class Toma3(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.toma3"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Ide.Toma3"


    
    cteos40_toma = fields.Selection(TOMA3_TOMA,
        string="Tomador do Serviço",
        xsd_required=True,
        help=(
            "Tomador do Serviço\nPreencher com:\n               0-Remetente;\n"
...
class Toma4(models.AbstractModel):
    """Indicador do "papel" do tomador do serviço no CT-e"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.toma4"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Ide.Toma4"


    
    cteos40_toma = fields.Selection(TOMA4_TOMA,
        string="Tomador do Serviço",
        xsd_required=True,
        help=(
            "Tomador do Serviço\nPreencher com: \n               4 - Outros\n"
...
class TcteCompl(models.AbstractModel):
    ...
    cteos40_fluxo = fields.Many2one(
        comodel_name="cteos.40.tcte_fluxo",
    ...
    cteos40_ObsCont = fields.One2many("cteos.40.tcte_obscont", "cteos40_ObsCont_compl_id",
        string="Campo de uso livre do contribuinte",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
    ...
    cteos40_ObsFisco = fields.One2many("cteos.40.tcte_obsfisco", "cteos40_ObsFisco_compl_id",
        string="ObsFisco",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
...
class TcteFluxo(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_fluxo"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Fluxo"


    
    cteos40_xOrig = fields.Char(
        string="xOrig",
        help=(
    ...
    cteos40_pass = fields.One2many("cteos.40.tcte_pass", "cteos40_pass_fluxo_id",
        string="pass"
    )
    
    cteos40_xDest = fields.Char(
        string="xDest",
        help=(
            "Sigla ou código interno da Filial/Porto/Estação/Aeroporto de "
            "Destino\nObservações para o modal "
...
class TctePass(models.AbstractModel):
    _description = "pass"
    _name = "cteos.40.tcte_pass"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Fluxo.Pass"


    cteos40_pass_fluxo_id = fields.Many2one(
        comodel_name="cteos.40.tcte_fluxo",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_xPass = fields.Char(
        string="xPass",
        help=(
            "Sigla ou código interno da Filial/Porto/Estação/Aeroporto de "
...
class Entrega(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.entrega"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega"


    
    cteos40_semData = fields.Many2one(
        comodel_name="cteos.40.semdata",
    ...
    cteos40_comData = fields.Many2one(
        comodel_name="cteos.40.comdata",
        string="Entrega com data definida",
        choice="entrega",
        xsd_choice_required=True
    )
    
    cteos40_noPeriodo = fields.Many2one(
        comodel_name="cteos.40.noperiodo",
        string="Entrega no período definido",
        choice="entrega",
        xsd_choice_required=True
    )
    
    cteos40_semHora = fields.Many2one(
        comodel_name="cteos.40.semhora",
        string="Entrega sem hora definida",
        choice="entrega",
        xsd_choice_required=True
    )
    
    cteos40_comHora = fields.Many2one(
        comodel_name="cteos.40.comhora",
        string="Entrega com hora definida",
        choice="entrega",
        xsd_choice_required=True
    )
    
    cteos40_noInter = fields.Many2one(
        comodel_name="cteos.40.nointer",
...
class SemData(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.semdata"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.SemData"


    
    cteos40_tpPer = fields.Selection(SEMDATA_TPPER,
        string="tpPer",
        xsd_required=True,
        help=(
            "Tipo de data/período programado para entrega\n0- Sem data "
...
class ComData(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.comdata"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.ComData"


    
    cteos40_tpPer = fields.Selection(COMDATA_TPPER,
        string="tpPer",
        xsd_required=True,
        help=(
            "Tipo de data/período programado para entrega\nPreencher "
...
class NoPeriodo(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.noperiodo"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.NoPeriodo"


    
    cteos40_tpPer = fields.Selection(NOPERIODO_TPPER,
        string="Tipo período",
        xsd_required=True,
        help="Tipo período\n4-no período"
    )
    
    cteos40_dIni = fields.Date(
        string="Data inicial",
        xsd_required=True,
        xsd_type="TData",
        help="Data inicial\nFormato AAAA-MM-DD"
...
class SemHora(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.semhora"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.SemHora"


    
    cteos40_tpHor = fields.Selection(SEMHORA_TPHOR,
        string="Tipo de hora",
        xsd_required=True,
        help="Tipo de hora\n0- Sem hora definida"
    )
...
class ComHora(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.comhora"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.ComHora"


    
    cteos40_tpHor = fields.Selection(COMHORA_TPHOR,
        string="Tipo de hora",
        xsd_required=True,
        help=(
            "Tipo de hora\nPreencher "
...
class NoInter(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.nointer"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.Compl.Entrega.NoInter"


    
    cteos40_tpHor = fields.Selection(NOINTER_TPHOR,
        string="Tipo de hora",
        xsd_required=True,
        help="Tipo de hora\n4 - No intervalo de tempo"
    )
    
    cteos40_hIni = fields.Char(
        string="Hora inicial",
        xsd_required=True,
        xsd_type="TTime",
        help="Hora inicial\nFormato HH:MM:SS"
...
class Exped(models.AbstractModel):
    ...
    cteos40_enderExped = fields.Many2one(
        comodel_name="cteos.40.tendereco",
        string="Dados do endereço",
        xsd_required=True,
        xsd_type="TEndereco"
...
class Receb(models.AbstractModel):
    ...
    cteos40_enderReceb = fields.Many2one(
        comodel_name="cteos.40.tendereco",
        string="Dados do endereço",
        xsd_required=True,
        xsd_type="TEndereco"
...
class TcteVPrest(models.AbstractModel):
    ...
    cteos40_Comp = fields.One2many("cteos.40.tcte_vprest_comp", "cteos40_Comp_vPrest_id",
        string="Componentes do Valor da Prestação"
    )
...
class TcteVPrestComp(models.AbstractModel):
    "Componentes do Valor da Prestação"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_vprest_comp"
    _inherit = "spec.mixin.cteos"
...
class TcteInfSolicNff(models.AbstractModel):
    "Grupo de informações do pedido de emissão da Nota Fiscal Fácil"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infsolicnff"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfSolicNff"


    
    cteos40_xSolic = fields.Char(
...
class TcteInfPaa(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infpaa"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfPaa"


    
    cteos40_CNPJPAA = fields.Char(
        string="CNPJ",
        xsd_required=True,
        xsd_type="TCnpj",
    ...
    cteos40_PAASignature = fields.Many2one(
        comodel_name="cteos.40.tcte_paasignature",
        string="Assinatura RSA",
        xsd_required=True,
...
class TctePaasignature(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_paasignature"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfPaa.Paasignature"


    
    cteos40_SignatureValue = fields.Char(
...
class TcteInfCteNorm(models.AbstractModel):
    "Grupo de informações do CT-e Normal e Substituto"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infctenorm"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm"


    
    cteos40_infCarga = fields.Many2one(
        comodel_name="cteos.40.tcte_infcarga",
        string="Informações da Carga do CT-e",
        xsd_required=True
    )
    
    cteos40_infDoc = fields.Many2one(
        comodel_name="cteos.40.infdoc",
        string="infDoc",
        help=(
    ...
    cteos40_docAnt = fields.Many2one(
        comodel_name="cteos.40.docant",
        string="Documentos de Transporte Anterior"
    )
    
    cteos40_infModal = fields.Many2one(
        comodel_name="cteos.40.tcte_infmodal",
        string="Informações do modal",
        xsd_required=True
    )
    
    cteos40_veicNovos = fields.One2many("cteos.40.veicnovos", "cteos40_veicNovos_infCTeNorm_id",
        string="informações dos veículos transportados"
    )
    
    cteos40_cobr = fields.Many2one(
        comodel_name="cteos.40.tcte_cobr",
        string="Dados da cobrança do CT-e"
    )
    
    cteos40_infCteSub = fields.Many2one(
        comodel_name="cteos.40.tcte_infctesub",
        string="Informações do CT-e de substituição"
    )
    
    cteos40_infGlobalizado = fields.Many2one(
        comodel_name="cteos.40.infglobalizado",
        string="Informações do CT-e Globalizado"
    )
    
    cteos40_infServVinc = fields.Many2one(
        comodel_name="cteos.40.infservvinc",
...
class TcteInfCarga(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infcarga"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfCarga"


    
    cteos40_vCarga = fields.Monetary(
    ...
    cteos40_infQ = fields.One2many("cteos.40.tcte_infq", "cteos40_infQ_infCarga_id",
        string="Informações de quantidades da Carga",
        help=(
            "Informações de quantidades da Carga do CT-e\nPara o Aéreo é "
    ...
    cteos40_vCargaAverb = fields.Monetary(
...
class TcteInfQ(models.AbstractModel):
    ...
    Aéreo)."""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infq"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfCarga.InfQ"


    cteos40_infQ_infCarga_id = fields.Many2one(
        comodel_name="cteos.40.tcte_infcarga",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_cUnid = fields.Selection(INFQ_CUNID,
...
class InfDoc(models.AbstractModel):
    """Informações dos documentos transportados pelo CT-e
    Opcional para Redespacho Intermediario e Serviço vinculado a multimodal.
    Poderá não ser informado para os CT-e de redespacho intermediário e serviço
    vinculado a multimodal. Nos demais casos deverá sempre ser informado."""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infdoc"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfDoc"


    
    cteos40_infNF = fields.One2many("cteos.40.infnf", "cteos40_infNF_infDoc_id",
    ...
    cteos40_infNFe = fields.One2many("cteos.40.tcte_infnfe", "cteos40_infNFe_infDoc_id",
        string="Informações das NF-e",
        choice="infdoc",
        xsd_choice_required=True
    )
    
    cteos40_infOutros = fields.One2many("cteos.40.infoutros", "cteos40_infOutros_infDoc_id",
        string="Informações dos demais documentos",
        choice="infdoc",
        xsd_choice_required=True
    )
    
    cteos40_infDCe = fields.One2many("cteos.40.infdce", "cteos40_infDCe_infDoc_id",
...
class InfNf(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infnf"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfDoc.InfNf"


    cteos40_infNF_infDoc_id = fields.Many2one(
        comodel_name="cteos.40.infdoc",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_nRoma = fields.Char(
        string="Número do Romaneio da NF"
    )
    
    cteos40_nPed = fields.Char(
        string="Número do Pedido da NF"
    )
    
    cteos40_mod = fields.Selection(TMODNF,
    ...
    cteos40_PIN = fields.Char(
        string="PIN SUFRAMA",
        help="PIN SUFRAMA\nPIN atribuído pela SUFRAMA para a operação."
    )
    
    cteos40_dPrev = fields.Date(
        string="Data prevista de entrega",
        xsd_type="TData",
        help="Data prevista de entrega\nFormato AAAA-MM-DD"
    )
    
    cteos40_infUnidCarga = fields.One2many("cteos.40.tunidcarga", "cteos40_infUnidCarga_infNF_id",
        string="Informações das Unidades de Carga",
        choice="infnf",
        xsd_choice_required=True,
        xsd_type="TUnidCarga",
    ...
    cteos40_infUnidTransp = fields.One2many("cteos.40.tunidadetransp", "cteos40_infUnidTransp_infNF_id",
...
class TcteInfNfe(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infnfe"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfDoc.InfNfe"


    cteos40_infNFe_infDoc_id = fields.Many2one(
        comodel_name="cteos.40.infdoc",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chave = fields.Char(
    ...
    cteos40_infUnidCarga = fields.One2many("cteos.40.tunidcarga", "cteos40_infUnidCarga_infNFe_id",
        string="Informações das Unidades de Carga",
        choice="infnfe",
        xsd_choice_required=True,
        xsd_type="TUnidCarga",
    ...
    cteos40_infUnidTransp = fields.One2many("cteos.40.tunidadetransp", "cteos40_infUnidTransp_infNFe_id",
        string="Informações das Unidades de Transporte",
        choice="infnfe",
        xsd_choice_required=True,
        xsd_type="TUnidadeTransp",
...
class InfOutros(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infoutros"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfDoc.InfOutros"


    cteos40_infOutros_infDoc_id = fields.Many2one(
        comodel_name="cteos.40.infdoc",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_tpDoc = fields.Selection(INFOUTROS_TPDOC,
    ...
    cteos40_descOutros = fields.Char(
    ...
    cteos40_vDocFisc = fields.Monetary(
    ...
    cteos40_infUnidCarga = fields.One2many("cteos.40.tunidcarga", "cteos40_infUnidCarga_infOutros_id",
        string="Informações das Unidades de Carga",
        choice="infoutros",
        xsd_choice_required=True,
        xsd_type="TUnidCarga",
    ...
    cteos40_infUnidTransp = fields.One2many("cteos.40.tunidadetransp", "cteos40_infUnidTransp_infOutros_id",
        string="Informações das Unidades de Transporte",
        choice="infoutros",
        xsd_choice_required=True,
        xsd_type="TUnidadeTransp",
...
class InfDce(models.AbstractModel):
    "Informações das DCe"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infdce"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfDoc.InfDce"


    cteos40_infDCe_infDoc_id = fields.Many2one(
        comodel_name="cteos.40.infdoc",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chave = fields.Char(
        string="Chave de acesso da DCe",
        xsd_required=True,
        xsd_type="TChDFe"
    )
...
class DocAnt(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.docant"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.DocAnt"


    
    cteos40_emiDocAnt = fields.One2many("cteos.40.emidocant", "cteos40_emiDocAnt_docAnt_id",
...
class EmiDocAnt(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.emidocant"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.DocAnt.EmiDocAnt"


    cteos40_emiDocAnt_docAnt_id = fields.Many2one(
        comodel_name="cteos.40.docant",
        xsd_implicit=True,
        ondelete="cascade"
    )
    ...
    cteos40_idDocAnt = fields.One2many("cteos.40.iddocant", "cteos40_idDocAnt_emiDocAnt_id",
        string="idDocAnt",
        help=(
...
class IdDocAnt(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.iddocant"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.DocAnt.EmiDocAnt.IdDocAnt"


    cteos40_idDocAnt_emiDocAnt_id = fields.Many2one(
        comodel_name="cteos.40.emidocant",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_idDocAntPap = fields.One2many("cteos.40.iddocantpap", "cteos40_idDocAntPap_idDocAnt_id",
        string="idDocAntPap",
        choice="iddocant",
        xsd_choice_required=True,
    ...
    cteos40_idDocAntEle = fields.One2many("cteos.40.iddocantele", "cteos40_idDocAntEle_idDocAnt_id",
        string="idDocAntEle",
        choice="iddocant",
        xsd_choice_required=True,
...
class IdDocAntPap(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.iddocantpap"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.DocAnt.EmiDocAnt.IdDocAnt.IdDocAntPap"


    cteos40_idDocAntPap_idDocAnt_id = fields.Many2one(
        comodel_name="cteos.40.iddocant",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_tpDoc = fields.Selection(TDOCASSOC,
    ...
    cteos40_subser = fields.Char(
        string="Série do Documento Fiscal (subser)"
    )
...
class VeicNovos(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.veicnovos"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.VeicNovos"


    cteos40_veicNovos_infCTeNorm_id = fields.Many2one(
        comodel_name="cteos.40.tcte_infctenorm",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chassi = fields.Char(
        string="Chassi do veículo",
        xsd_required=True
    )
    
    cteos40_cCor = fields.Char(
        string="Cor do veículo",
        xsd_required=True,
        help="Cor do veículo\nCódigo de cada montadora"
    )
    
    cteos40_xCor = fields.Char(
        string="Descrição da cor",
        xsd_required=True
    )
    
    cteos40_cMod = fields.Char(
        string="Código Marca Modelo",
        xsd_required=True,
        help="Código Marca Modelo\nUtilizar tabela RENAVAM"
    )
    
    cteos40_vUnit = fields.Monetary(
    ...
    cteos40_vFrete = fields.Monetary(
...
class TcteCobr(models.AbstractModel):
    ...
    cteos40_fat = fields.Many2one(
        comodel_name="cteos.40.tcte_fat",
        string="Dados da fatura"
    )
    
    cteos40_dup = fields.One2many("cteos.40.tcte_dup", "cteos40_dup_cobr_id",
        string="Dados das duplicatas"
    )
...
class TcteInfCteSub(models.AbstractModel):
    ...
    cteos40_indAlteraToma = fields.Selection(INFCTESUB_INDALTERATOMA,
...
class InfServVinc(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infservvinc"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfServVinc"


    
    cteos40_infCTeMultimodal = fields.One2many("cteos.40.infctemultimodal", "cteos40_infCTeMultimodal_infServVinc_id",
...
class InfCteMultimodal(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infctemultimodal"
    _inherit = "spec.mixin.cteos"
    _binding_type = "Tcte.InfCte.InfCteNorm.InfServVinc.InfCteMultimodal"


    cteos40_infCTeMultimodal_infServVinc_id = fields.Many2one(
        comodel_name="cteos.40.infservvinc",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chCTeMultimodal = fields.Char(
...
class TcteInfCteComp(models.AbstractModel):
    "Detalhamento do CT-e complementado"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infctecomp"
    _inherit = "spec.mixin.cteos"
...
class TcteInfCteSupl(models.AbstractModel):
    "Informações suplementares da GTV-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tcte_infctesupl"
    _inherit = "spec.mixin.cteos"
...
class TcteSimp(models.AbstractModel):
    ...
    cteos40_infCte = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infcte",
        string="Informações do CT-e",
        xsd_required=True
    )
    
    cteos40_infCTeSupl = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infctesupl",
        string="Informações suplementares do CT-e"
    )
...
class TcteSimpInfCte(models.AbstractModel):
    "Informações do CT-e do tipo GTV-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infcte"
    _inherit = "spec.mixin.cteos"
    ...
    cteos40_ide = fields.Many2one(
        comodel_name="cteos.40.tctesimp_ide",
        string="Identificação do CT-e",
        xsd_required=True
    )
    
    cteos40_compl = fields.Many2one(
        comodel_name="cteos.40.tctesimp_compl",
        string="Dados complementares",
        help=(
            "Dados complementares do CT-e para fins operacionais ou comerciais"
        )
    ...
    cteos40_emit = fields.Many2one(
        comodel_name="cteos.40.tctesimp_emit",
        string="Identificação do Emitente do CT-e",
        xsd_required=True
    )
    
    cteos40_toma = fields.Many2one(
        comodel_name="cteos.40.tctesimp_toma",
    ...
    cteos40_infCarga = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infcarga",
        string="Informações da Carga do CT-e",
        xsd_required=True
    )
    
    cteos40_det = fields.One2many("cteos.40.det", "cteos40_det_infCte_id",
        string="Detalhamento das entregas / prestações",
        help="Detalhamento das entregas / prestações do CTe Simplificado"
    )
    
    cteos40_infModal = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infmodal",
        string="Informações do modal",
        xsd_required=True
    )
    
    cteos40_cobr = fields.Many2one(
        comodel_name="cteos.40.tctesimp_cobr",
        string="Dados da cobrança do CT-e"
    )
    
    cteos40_infCteSub = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infctesub",
        string="Informações do CT-e de substituição"
    )
    
    cteos40_imp = fields.Many2one(
        comodel_name="cteos.40.tctesimp_imp",
        string="Informações relativas aos Impostos",
        xsd_required=True
    )
    
    cteos40_total = fields.Many2one(
        comodel_name="cteos.40.total",
        string="Valores Totais do CTe",
        xsd_required=True
    )
    
    cteos40_autXML = fields.One2many("cteos.40.tctesimp_autxml", "cteos40_autXML_infCte_id",
        string="Autorizados para download do XML do DF-e",
        help=(
            "Autorizados para download do XML do DF-e\nInformar CNPJ ou CPF. "
            "Preencher os zeros não significativos."
    ...
    cteos40_infSolicNFF = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infsolicnff",
        string="Grupo de informações",
        help=(
            "Grupo de informações do pedido de emissão da Nota Fiscal Fácil"
        )
    ...
    cteos40_infPAA = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infpaa",
        string="Grupo de Informação",
        help="Grupo de Informação do Provedor de Assinatura e Autorização"
    )
...
class TcteSimpIde(models.AbstractModel):
    ...
    cteos40_tpEmis = fields.Selection(IDE_TPEMIS_2,
        string="Forma de emissão do CT-e",
        xsd_required=True,
        help=(
            "Forma de emissão do CT-e\nPreencher com:\n1 - Normal;\n3 - Regime"
    ...
    cteos40_tpCTe = fields.Selection(TFINCTESIMP,
    ...
    cteos40_modal = fields.Selection(TMODTRANSPSIMP,
        string="Modal",
        xsd_required=True,
        help=(
            "Modal\nPreencher com:\n01-Rodoviário\n02-Aéreo\n03-Aquaviário"
    ...
    cteos40_tpServ = fields.Selection(IDE_TPSERV_2,
        string="Tipo do Serviço",
        xsd_required=True,
        help=(
            "Tipo do Serviço\nPreencher com: \n0 - Normal;\n1 - "
...
class TcteSimpCompl(models.AbstractModel):
    ...
    cteos40_fluxo = fields.Many2one(
        comodel_name="cteos.40.tctesimp_fluxo",
        string="Previsão do fluxo da carga",
        help=(
            "Previsão do fluxo da carga\nPreenchimento obrigatório para o "
            "modal aéreo."
    ...
    cteos40_ObsCont = fields.One2many("cteos.40.tctesimp_obscont", "cteos40_ObsCont_compl_id",
        string="Campo de uso livre do contribuinte",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
    ...
    cteos40_ObsFisco = fields.One2many("cteos.40.tctesimp_obsfisco", "cteos40_ObsFisco_compl_id",
        string="ObsFisco",
        help=(
            "Campo de uso livre do contribuinte\nInformar o nome do campo no "
            "atributo xCampo e o conteúdo do campo no XTexto"
...
class TcteSimpFluxo(models.AbstractModel):
    ...
    cteos40_pass = fields.One2many("cteos.40.tctesimp_pass", "cteos40_pass_fluxo_id",
        string="pass"
    )
...
class TcteSimpObsCont(models.AbstractModel):
    ...
    Informar o nome do campo no atributo xCampo e o conteúdo do campo no XTexto"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_obscont"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpObsFisco(models.AbstractModel):
    ...
    Informar o nome do campo no atributo xCampo e o conteúdo do campo no XTexto"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_obsfisco"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpToma(models.AbstractModel):
    """Indicador do "papel" do tomador do serviço no GT-e"""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_toma"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteSimp.InfCte.Toma"


    
    cteos40_toma = fields.Selection(TOMA_TOMA_2,
        string="Tomador do Serviço",
        xsd_required=True,
        help=(
            "Tomador do Serviço\nPreencher com:\n\n0-Remetente;\n1-"
    ...
    cteos40_indIEToma = fields.Selection(TOMA_INDIETOMA,
        string="Indicador do papel",
        xsd_required=True,
        help=(
            "Indicador do papel do tomador na prestação do serviço:\n1 – "
...
class TcteSimpInfCarga(models.AbstractModel):
    "Informações da Carga do CT-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infcarga"
    _inherit = "spec.mixin.cteos"
    ...
    cteos40_infQ = fields.One2many("cteos.40.tctesimp_infq", "cteos40_infQ_infCarga_id",
        string="Informações de quantidades da Carga",
        help=(
            "Informações de quantidades da Carga do CT-e\nPara o Aéreo é "
            "obrigatório o preenchimento desse campo da seguinte forma.\n1 - "
...
class TcteSimpInfQ(models.AbstractModel):
    ...
    cteos40_tpMed = fields.Selection(INFQ_TPMED,
        string="Tipo da Medida",
        xsd_required=True,
        help=(
            "Tipo da Medida\nInformar com:\n00-Cubagem da NF-e\n01-Cubagem "
...
class Det(models.AbstractModel):
    ...
    cteos40_det_infCte_id = fields.Many2one(
        comodel_name="cteos.40.tctesimp_infcte",
        xsd_implicit=True,
        ondelete="cascade"
    )
    ...
    cteos40_vPrest = fields.Monetary(
    ...
    cteos40_Comp = fields.One2many("cteos.40.tctesimp_det_comp", "cteos40_Comp_det_id",
        string="Componentes do Valor da Prestação"
    )
    
    cteos40_infNFe = fields.One2many("cteos.40.tctesimp_infnfe", "cteos40_infNFe_det_id",
        string="Informações das NF-e",
        choice="det",
        xsd_choice_required=True
    )
    
    cteos40_infDocAnt = fields.One2many("cteos.40.infdocant", "cteos40_infDocAnt_det_id",
        string="Documentos anteriores",
        choice="det",
        xsd_choice_required=True
    )
    
    cteos40_nItem = fields.Char(
...
class TcteSimpDetComp(models.AbstractModel):
    "Componentes do Valor da Prestação"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_det_comp"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteSimp.InfCte.Det.Comp"


    cteos40_Comp_det_id = fields.Many2one(
        comodel_name="cteos.40.det",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_xNome = fields.Char(
...
class TcteSimpInfNfe(models.AbstractModel):
    "Informações das NF-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infnfe"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteSimp.InfCte.Det.InfNfe"


    cteos40_infNFe_det_id = fields.Many2one(
        comodel_name="cteos.40.det",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chNFe = fields.Char(
        string="Chave de acesso da NF-e",
        xsd_required=True
    )
...
class InfDocAnt(models.AbstractModel):
    ...
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.infdocant"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteSimp.InfCte.Det.InfDocAnt"


    cteos40_infDocAnt_det_id = fields.Many2one(
        comodel_name="cteos.40.det",
        xsd_implicit=True,
        ondelete="cascade"
    )
    ...
    cteos40_tpPrest = fields.Selection(INFDOCANT_TPPREST,
        string="indica se",
        xsd_required=True,
        help=(
            "indica se a prestação é total ou parcial em relação as notas do "
    ...
    cteos40_infNFeTranspParcial = fields.One2many("cteos.40.infnfetranspparcial", "cteos40_infNFeTranspParcial_infDocAnt_id",
...
class InfNfeTranspParcial(models.AbstractModel):
    ...
    _name = "cteos.40.infnfetranspparcial"
    _inherit = "spec.mixin.cteos"
    _binding_type = "TcteSimp.InfCte.Det.InfDocAnt.InfNfeTranspParcial"


    cteos40_infNFeTranspParcial_infDocAnt_id = fields.Many2one(
        comodel_name="cteos.40.infdocant",
        xsd_implicit=True,
        ondelete="cascade"
    )
    cteos40_chNFe = fields.Char(
...
class TcteSimpInfModal(models.AbstractModel):
    "Informações do modal"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infmodal"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpCobr(models.AbstractModel):
    ...
    cteos40_fat = fields.Many2one(
        comodel_name="cteos.40.tctesimp_fat",
        string="Dados da fatura"
    )
    
    cteos40_dup = fields.One2many("cteos.40.tctesimp_dup", "cteos40_dup_cobr_id",
        string="Dados das duplicatas"
    )
...
class TcteSimpInfCteSub(models.AbstractModel):
    "Informações do CT-e de substituição"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infctesub"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpAutXml(models.AbstractModel):
    ...
    Informar CNPJ ou CPF. Preencher os zeros não significativos."""
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_autxml"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpInfSolicNff(models.AbstractModel):
    "Grupo de informações do pedido de emissão da Nota Fiscal Fácil"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infsolicnff"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpInfPaa(models.AbstractModel):
    "Grupo de Informação do Provedor de Assinatura e Autorização"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infpaa"
    _inherit = "spec.mixin.cteos"
    ...
    cteos40_PAASignature = fields.Many2one(
        comodel_name="cteos.40.tctesimp_paasignature",
        string="Assinatura RSA",
        xsd_required=True,
        help="Assinatura RSA do Emitente para DFe gerados por PAA"
    )
...
class TcteSimpPaasignature(models.AbstractModel):
    "Assinatura RSA do Emitente para DFe gerados por PAA"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_paasignature"
    _inherit = "spec.mixin.cteos"
...
class TcteSimpInfCteSupl(models.AbstractModel):
    "Informações suplementares da GTV-e"
    _description = textwrap.dedent(f"    {__doc__}")
    _name = "cteos.40.tctesimp_infctesupl"
    _inherit = "spec.mixin.cteos"
