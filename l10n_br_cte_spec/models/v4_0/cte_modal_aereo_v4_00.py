...
INFTOTAP_UNIAP = [
    ...
    (
        "5",
        (
            "Unidades (apenas para artigos perigosos medidos em unidades que não se "
...
NATCARGA_CINFMANU = [
    ...
    (
        "08",
        (
            "artigo perigoso em carga consolidada (especificar a quantidade no campo "
            "observações)"
        ),
    ),
    (
        "09",
        (
            "autorização da autoridade governamental anexa (especificar no campo "
            "observações)"
        ),
    ),
