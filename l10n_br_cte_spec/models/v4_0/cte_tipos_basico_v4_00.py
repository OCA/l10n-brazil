...
class DetGtv(models.AbstractModel):
    ...
    cte40_infVeiculo = fields.One2many(
        ...
        help=("Grupo de informações dos veículos utilizados no transporte de valores"),
    )
...
class TcteSimpCobr(models.AbstractModel):
    ...
    cte40_dup = fields.One2many(
        "cte.40.tctesimp_dup", "cte40_dup_cobr_id", string="Dados das duplicatas"
    )
