    ...
    def test_04_limite_abono(self):
        ...
        with self.assertRaises(Warning):
            self.hr_holidays.create({
                ...
                'number_of_days_temp': 30,
                'date_from': fields.Datetime.from_string('2017-12-10 07:00:0'),
    ...
    def test_06_limite_dias_periodo_aquisitivo(self):
        ...
        with self.assertRaises(Warning):
            self.hr_holidays.create({
                ...
                'date_from': fields.Datetime.from_string('2017-01-01 07:00:0'),
                'date_to': fields.Datetime.from_string('2017-01-21 19:00:00'),
            })
    ...
    def test_08_limite_dias_periodo_aquisitivo(self):
        ...
        with self.assertRaises(Warning):
            self.hr_holidays.create({
                ...
                'date_from': fields.Datetime.from_string('2017-08-01 07:00:0'),
                'date_to': fields.Datetime.from_string('2017-08-10 19:00:00'),
            })
    ...
    def test_09_limite_dias_periodo_aquisitivo(self):
        ...
        with self.assertRaises(Warning):
            self.hr_holidays.create({
                ...
                'number_of_days_temp': 15,
                'date_from': fields.Datetime.from_string('2017-08-01 07:00:0'),
                'date_to': fields.Datetime.from_string('2017-08-09 19:00:00'),
            })
