...
TIPO_SERVICO = [
    ...
    (BOLETO_PAGAMENTO_ELETRONICO, BOLETO_PAGAMENTO_ELETRONICO + u' - Boleto de Pagamento Eletrônico'),
    ...
    (CONSULTA_INFORMACAO_MARGEM, CONSULTA_INFORMACAO_MARGEM + u' - Consulta/Informação Margem'),
    (AVERBACAO_CONSIGNACAO_RETENCAO, AVERBACAO_CONSIGNACAO_RETENCAO + u' - Averbação da Consignação/Retenção'),
    ...
    (CONSULTA_TRIBUTOS_PAGAR, CONSULTA_TRIBUTOS_PAGAR + u' - Consulta de Tributos a pagar'),
    (PAGAMENTO_FORNECEDOR, PAGAMENTO_FORNECEDOR + u' - Pagamento Fornecedor'),
    (PAGAMENTO_CONTAS_TRIBUTOS_IMPOSTOS, PAGAMENTO_CONTAS_TRIBUTOS_IMPOSTOS + u' - Pagamento de Contas, Tributos e Impostos'),
    (INTEROPERABILIDADE_CONTAS, INTEROPERABILIDADE_CONTAS + u' - Interoperabilidade entre Contas de Instituições de Pagamentos'),
    ...
    (PAGAMENTO_BOLSA_AUXILIO, PAGAMENTO_BOLSA_AUXILIO + u' - Pagamento de bolsa auxílio'),
    (PAGAMENTO_PREBENDA, PAGAMENTO_PREBENDA + u' - Pagamento de prebenda (remuneração a padres e sacerdotes)'),
    (VENDOR, VENDOR + u' - Vendor'),
    (VENDOR_TERMO, VENDOR_TERMO + u' - Vendor a Termo'),
    (PAGAMENTO_SINISTROS_SEGURADOS, PAGAMENTO_SINISTROS_SEGURADOS + u' - Pagamento Sinistros Segurados'),
    (PAGAMENTO_DESPESAS_VIAJANTE, PAGAMENTO_DESPESAS_VIAJANTE + u' - Pagamento Despesas Viajante em Trânsito'),
    ...
    (PAGAMENTO_REPRESENTANTES, PAGAMENTO_REPRESENTANTES + u' - Pagamento Representantes / Vendedores Autorizados'),
...
PAGAMENTO_CONTAS_TRIBUTOS_CODIGO_BARRAS = ('11', u'11 - Pagamento de Contas e Tributos com Código de Barras')
...
LIQUIDACAO_TITULOS_PROPRIO_BANCO = ('30', u'30 - Liquidação de Títulos do Próprio Banco')
...
TED_TRANSFERENCIA_CONTA_INVESTIMENTO = ('44', u'44 - TED para Transferência de Conta Investimento')
...
OPERACOES_CAMBIOS_FUNDOS_BOLSA = ('08', u'08 - Operações de Câmbios/Fundos/Bolsa de Valores')
...
PAGAMENTO_PREBENDA_C = ('19', u'19 - Pagamento de prebenda (Remuneração a padres e sacerdotes)')
...
CODIGO_INSTRUCAO_MOVIMENTO = [
    ...
    ('33', u'33 - Estorno por Devolução da Câmara Centralizadora (somente para Tipo de Movimento = \'3\')'),
...
CODIGO_OCORRENCIAS = [
    ...
    ('AK', u'AK - Código da Câmara de Compensação do Banco Favorecido/Depositário Inválido'),
    ('AL', u'AL - Código do Banco Favorecido, Instituição de Pagamento ou Depositário Inválido'),
    ('AM', u'AM - Agência Mantenedora da Conta Corrente do Favorecido Inválida'),
    ('AN', u'AN - Conta Corrente/DV/Conta de Pagamento do Favorecido Inválido'),
    ...
    ('HC', u'HC - Convênio com a Empresa Inexistente/Inválido para o Contrato'),
    ('HD', u'HD - Agência/Conta Corrente da Empresa Inexistente/Inválido para o Contrato'),
    ...
    ('HW', u'HW - Margem consignável excedida para o mutuário dentro do prazo do contrato'),
    ...
    ('H7', u'H7 - Margem consignável excedida para o mutuário acima do prazo do contrato'),
    ('H8', u'H8 - Mutuário desligado do empregador'),
    ('H9', u'H9 - Mutuário afastado por licença'),
    ('IA', u'IA - Primeiro nome do mutuário diferente do primeiro nome do movimento do censo ou diferente da base de Titular do Benefício'),
    ...
    ('IK', u'IK - Benefício cessado: estatutário transferido para órgão de origem'),
    ...
    ('IP', u'IP - Fim do empréstimo ocorreu durante período de suspensão ou concessão'),
    ('IQ', u'IQ - Empréstimo suspenso pelo banco'),
    ('IR', u'IR - Não averbação de contrato – quantidade de parcelas/competências informadas ultrapassou a data limite da extinção de cota do dependente titular de benefícios'),
    ...
    ('ZB', u'ZB - Divergência entre o primeiro e último nome do beneficiário versus primeiro e último nome na Receita Federal'),
    ('ZC', u'ZC - Confirmação de Antecipação de Valor'),
    ('ZD', u'ZD - Antecipação parcial de valor'),
    ('ZE', u'ZE - Título bloqueado na base'),
    ('ZF', u'ZF - Sistema em contingência – título valor maior que referência'),
