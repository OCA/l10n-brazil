...
# Generated Sat Mar 23 21:34:11 2019 by generateDS.py(Akretion's branch).
...
class ICMS(spec_models.AbstractSpecMixin):
    ...
    nfe40_ICMSSN202 = fields.Many2one(
        "nfe.40.icmssn202",
        choice='11',
        string="ICMSSN202", xsd_required=True,
...
class Med(spec_models.AbstractSpecMixin):
    ...
    nfe40_cProdANVISA = fields.Char(
        ...
        "\nObs.: Para medicamento isento de registro na ANVISA, utilizar o"
        "\nnúmero da decisão que o isenta, como por exemplo o número"
        "\nda Resolução da Diretoria Colegiada da ANVISA (RDC).")
