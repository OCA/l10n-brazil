...
class AccountTax(models.Model):
    ...
    # # TODO criar uma parametro na empresa para desagrupar por imposto
    # def get_grouping_key(self, invoice_tax_val):
    #     """ Returns a string that will be used to group account.invoice.tax
    #     sharing the same properties"""
    #     grouping_key = super().get_grouping_key(invoice_tax_val)
    #     return grouping_key + '-' + str(invoice_tax_val['fiscal_tax_id'])
