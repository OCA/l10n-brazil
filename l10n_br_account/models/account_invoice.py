...
class AccountInvoice(models.Model):
    ...
    def invoice_line_move_line_get(self):
        ...
        for line in move_lines_dict:
            ...
            # TODO pegar o fiscal_tax_ids e deduzir os impostos da receita/despesa
            # if not invoice_line.fiscal_operation_id.deductible_taxes:
            #     line['price'] = (
            #         invoice_line.price_subtotal - (invoice_line.icms_value +
            #             invoice_line.pis_value + invoice_line.cofins_value)
            #     )
            #
            # else:
