    ...
    def _serializer(self, cr, uid, ids, nfe_environment, context=None):
        ...
        for inv in pool.get('account.invoice').browse(cr, uid, ids, context):
            ...
            for inv_line in inv.invoice_line:
                ...
                det.prod.vUnCom.valor = str("%.7f" % (inv_line.price_unit * (1-(inv_line.discount or 0.0)/100.0)))#FIXME
                det.prod.vProd.valor = str("%.2f" % inv_line.price_total) #FIXME
            ...
            nfe.infNFe.total.ICMSTot.vDesc.valor   = '0.00' #FIXME
