...
class TestDocumentEdition(TransactionCase):
    ...
    def test_landed_costs_by_line_and_by_total(self):
        ...
        1. By Line: Enters costs on lines and verifies the header totals are summed up correctly.
        2. By Total: Enters costs on the header and verifies they are distributed to lines correctly.
        """
        ...
        # Assert values were distributed proportionally to price_gross (2000 vs 500 -> 80% vs 20%)
        ...
        # Line 1 IPI Base = 2000 (product) + 24 (freight) + 48 (insurance) + 72 (other) = 2144
        ...
        # Line 2 IPI Base = 500 (product) + 6 (freight) + 12 (insurance) + 18 (other) = 536
