...
bonificação). Ver planejamento/SANEAMENTO_OPERACOES_BASE.md.
...
def migrate(env, version):
    ...
    if bonif:
        vals = {"ind_ie_dest": "1", "product_type": "00", "tax_icms_or_issqn": "icms"}
        bonif.write({k: v for k, v in vals.items() if not bonif[k]})
