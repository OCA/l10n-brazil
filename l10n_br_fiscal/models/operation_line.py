...
class OperationLine(models.Model):
    ...
    icms_base_add_ipi = fields.Boolean(
        string='Add IPI value in ICMS base amount?')

    icms_st_base_add_ipi = fields.Boolean(
        string='Add IPI value in ICMS ST base amount?')

    # IPI Fields
    ipi_custom = fields.Boolean(
        string='Custom IPI',
        default=False)
    ...
    # PIS/COFINS Fields
    pis_cofins_custom = fields.Boolean(
        string='Custom PIS/COFINS',
        default=False)
    ...
    pis_cofins_revenue_code = fields.Char(
        string='PIS/COFINS Revenue Code',
        size=3)
