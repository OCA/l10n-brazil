...
from ..constants.fiscal import (NCM_FOR_SERVICE_REF, PRODUCT_FISCAL_TYPE,
...
class ProductTemplate(models.Model):
    ...
    icms_origin = fields.Selection(
        selection=ICMS_ORIGIN, string="ICMS Origin", default="0"
    )
    ...
    fiscal_genre_code = fields.Char(
        related="fiscal_genre_id.code", store=True, string="Fiscal Genre Code"
    )
