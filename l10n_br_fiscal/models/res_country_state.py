...
class L10nBrTaxDefinitionStateProduct(L10nBrTaxDefinitionCompanyProduct, models.Model):
    _name = "l10n_br_tax.definition.state.product"

    state_id = fields.Many2one(comodel_name="res.country.state", string=u"Estado")
