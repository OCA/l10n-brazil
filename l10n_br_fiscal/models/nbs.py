...
class Nbs(models.Model):
    ...
    _sql_constraints = [
        ("fiscal_nbs_code_uniq", "unique (code)", "NBS already exists with this code !")
    ]
    ...
    def get_ibpt(self):
        ...
        for nbs in self:
            try:
                ...
                result = get_ibpt_service(config, nbs.code_unmasked)
                ...
                nbs.message_post(body=str(e), subject=_("NBS Tax Estimate Failure"))
                continue
