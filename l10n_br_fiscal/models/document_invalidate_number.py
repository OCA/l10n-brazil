...
class InvalidateNumber(models.Model):
    _name = 'l10n_br_fiscal.document.invalidate_number'
    ...
    company_id = fields.Many2one(
        ...
        default=lambda self: self.env['res.company']._company_default_get(
            'l10n_br_fiscal.document.invalidate_number'))

    document_serie_id = fields.Many2one(
        'l10n_br_fiscal.document.serie', u'Série',
        domain="[('fiscal_document_id', '=', document_id), "
    ...
    invalid_number_document_event_ids = fields.One2many(
        'l10n_br_fiscal.document_event', 'invalid_number_document_event_id',
