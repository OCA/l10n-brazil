...
from ..constants.fiscal import (CERTIFICATE_SUBTYPE,
                                CERTIFICATE_SUBTYPE_DEFAULT, CERTIFICATE_TYPE,
...
class Certificate(models.Model):
    ...
    def _certificate_data(self, cert_file, cert_password):
        ...
        if cert_file and cert_password:
            try:
                cert = certificado.Certificado(b64decode(cert_file), cert_password)
