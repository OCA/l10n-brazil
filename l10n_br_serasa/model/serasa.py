...
class Serasa(models.Model):
    ...
    data_consulta = fields.Datetime(
        "Data Consulta", default=datetime.now(), readonly=True
    )
    ...
    protesto_num_ocorrencias = fields.Integer(
        "Total de ocorrências Protestos Estaduais", readonly=True
    )
    ...
    pefin_num_ocorrencias = fields.Integer(
        "Total de ocorrências Pendências Financeiras", readonly=True
    )
    ...
    cheque_num_ocorrencias = fields.Integer(
        "Total de ocorrências Cheques", readonly=True
    )
    ...
    def _check_partner(self):
        ...
        if not company.cnpj_cpf:
            ...
            raise Warning("O CNPJ da empresa consultante não pode estar em branco.")
        ...
        if (
            retorno_consulta == "Usuario ou senha do serasa invalidos"
        ...
        if retorno_consulta["total_pefin"]:
            ...
            self.write({"pefin_num_ocorrencias": 0, "pefin_valor_total": 0})
        ...
        if retorno_consulta["total_refin"]:
            ...
            self.write({"refin_num_ocorrencias": 0, "refin_valor_total": 0})
            ...
            self.write(
                {
                    ...
                    "protesto_valor_total": retorno_consulta["total_protesto"]["total"],
                }
            )
        else:
            self.write({"protesto_num_ocorrencias": 0, "protesto_valor_total": 0})
        ...
        if retorno_consulta["total_cheque"]:
            ...
            self.write({"cheque_num_ocorrencias": 0})
