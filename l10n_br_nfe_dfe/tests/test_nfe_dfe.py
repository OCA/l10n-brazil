...
class TestDFe(TransactionCase):
    ...
    def test_search_dfe_success(self, mock_post):
        ...
        self.assertEqual(self.company.nfe_last_nsu, utils.format_nsu("201"))
    ...
    def test_search_dfe_error_conditions(self):
        ...
        with mock.patch.object(
            ...
            self.company.nfe_dfe_search_documents()
            self.assertEqual(self.company.nfe_last_nsu, "0")
        ...
        with mock.patch.object(
            ...
            self.company.nfe_dfe_next_query = False
            self.company.nfe_dfe_search_documents()
            self.assertEqual(
                self.company.nfe_last_nsu,
                "0",
    ...
    def test_cron_search_documents(self):
        ...
        self.company.nfe_auto_fetch = True
    ...
    def test_search_specific_zero_nsu(self, mock_post):
        ...
        self.company._dfe_search_specific_document("nfe", access_key=access_key)
    ...
    def test_zero_nsu_different_documents(self, mock_post):
        ...
        DfeRecord = self.env["l10n_br_fiscal_dfe.dfe"]
        self.company._dfe_search_specific_document("nfe", access_key="any_key")
    ...
    def test_cooldown_after_137(self, mock_post):
        ...
        self.company.nfe_dfe_search_documents()
        self.assertEqual(self.company.nfe_dfe_last_status_code, "137")
        self.assertTrue(self.company.nfe_dfe_next_query)

        # Second call: should be blocked by dfe_next_query
        mock_post.reset_mock()
        result = self.company.action_document_distribution("nfe")
    ...
    def test_cooldown_skipped_when_next_query_passed(self, mock_post):
        ...
        self.company.nfe_dfe_next_query = fields.Datetime.now() - timedelta(minutes=1)
    ...
    def test_schedule_after_success(self, mock_post):
        ...
        self.assertTrue(self.company.nfe_dfe_next_query)
        self.assertGreaterEqual(
            self.company.nfe_dfe_next_query, before + DFE_INTERVAL_SUCCESS
        )
        self.assertLessEqual(
            self.company.nfe_dfe_next_query, after + DFE_INTERVAL_SUCCESS
        )
    ...
    def test_schedule_after_137(self, mock_post):
        ...
        self.assertTrue(self.company.nfe_dfe_next_query)
        self.assertGreaterEqual(
            self.company.nfe_dfe_next_query, before + DFE_INTERVAL_NO_DOCS
        )
        self.assertLessEqual(
            self.company.nfe_dfe_next_query, after + DFE_INTERVAL_NO_DOCS
        )
    ...
    def test_schedule_after_exception(self):
        ...
        self.assertTrue(self.company.nfe_dfe_next_query)
        self.assertGreaterEqual(
            self.company.nfe_dfe_next_query, before + DFE_INTERVAL_ERROR
        )
        self.assertLessEqual(
            self.company.nfe_dfe_next_query, after + DFE_INTERVAL_ERROR
        )

    def test_cron_skips_company_not_ready(self):
        """Cron should skip companies whose dfe_next_query is in the future."""
        self.company.nfe_auto_fetch = True
        self.company.nfe_dfe_next_query = fields.Datetime.now() + timedelta(hours=2)

        with mock.patch.object(DefaultTransport, "post") as mock_post:
            self.env["res.company"]._cron_nfe_dfe_search_documents()
            mock_post.assert_not_called()
    ...
    def test_ciencia_does_not_reschedule_during_656(self):
        ...
        self.company.nfe_dfe_last_status_code = "656"
        self.company.nfe_dfe_next_query = fields.Datetime.now() + timedelta(hours=1)
        original_next_query = self.company.nfe_dfe_next_query
        ...
        self.assertEqual(
            self.company.nfe_dfe_next_query,
            original_next_query,
    ...
    def test_ciencia_reschedules_after_137(self):
        ...
        self.company.nfe_dfe_last_status_code = "137"
    ...
    def _create_wizard(self, **kwargs):
        ...
        return self.env["dfe.specific.search.wizard"].create(defaults)
    ...
    def test_create_from_resEvento(self, mock_post):
        ...
        self.assertEqual(dfe_record.document_type_dfe, "event")
    ...
    def test_action_banner_search_all(self):
        ...
        with mock.patch.object(
            ...
            result = ResCompany.action_banner_search_all_nfe()
    ...
    def test_action_banner_specific_search(self):
        ...
        ResCompany = self.env["res.company"].with_company(self.company)
        result = ResCompany.action_banner_specific_search_nfe()
    ...
    def test_specific_search_no_docs(self, mock_post):
        ...
        self.company._dfe_search_specific_document("nfe", access_key=key)
    ...
    def test_notify_own_documents_skipped(self):
        ...
        self.company._dfe_notify_users(doc, "nfe")
    ...
    def test_sync_cron_nextcall_no_cron(self):
        ...
        with mock.patch.object(
            ...
            # Should not raise
            self.company._dfe_sync_cron_nextcall("nfe")
    ...
    def test_get_or_create_document_short_key(self):
        ...
        doc = self.company._dfe_get_or_create_document("SHORT_KEY", "nfe")
        self.assertTrue(doc)
