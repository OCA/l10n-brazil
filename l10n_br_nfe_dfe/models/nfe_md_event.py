...
class NfeRecipientManifestationEvent(models.Model):
    ...
    def action_confirm(self):
        """
        When a manifestation (like Ciência) is confirmed, schedule a new
        DF-e query soon to get the full XML.
        """
