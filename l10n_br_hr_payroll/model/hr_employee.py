...
class HrEmployee(osv.osv):
    ...
    _columns = {
        ...
        'cr_categ': fields.selection([
            ('estagiario', 'Trainee'), ('junior', 'Junior'),
        ...
        'cpf': fields.related('address_home_id', 'cnpj_cpf',
                              type='char', string='CPF', required=True),
        ...
        'n_dependent': fields.function(
            _get_dependents, type="float",
    ...
    _constraints = [
        [_validate_pis_pasep, u'PIS/PASEP is invalid.', ['pis_pasep']]]
    ...
    def onchange_user(self, cr, uid, ids, user_id, context=None):
        ...
        res['value'].update(
            {'address_home_id': partner.id, 'cpf': partner.cnpj_cpf})
        return res
...
class HrEmployeeDependent(osv.osv):
    ...
    _columns = {
        ...
        'dependent_verification': fields.boolean('Is dependent',
                                                 required=False),
        'health_verification': fields.boolean('Health Plan',
                                              required=False),
    }
