...
odoo.define(
    "l10n_br_portal.l10n_br_portal",
    ["@web/legacy/js/public/public_widget", "@web/core/network/rpc"],
    function (require) {
        "use strict";

        var publicWidgetModule = require("@web/legacy/js/public/public_widget");
        var publicWidget = publicWidgetModule.default || publicWidgetModule;
        var rpc = require("@web/core/network/rpc").rpc;
