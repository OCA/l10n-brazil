...
class DocumentLine(models.Model):
    ...
    def prepare_line_servico(self):
        return {
            ...
            'valor_pis': float(self.pis_wh_value),
            'valor_cofins': float(self.cofins_wh_value),
            'valor_inss': float(self.inss_wh_value),
            'valor_ir': float(self.irpj_wh_value),
            'valor_csll': float(self.csll_wh_value),
