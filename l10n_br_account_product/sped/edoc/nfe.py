...
from openerp.addons.l10n_br_account.sped.edoc.document import ElectronicDocument


class NfeEdoc(ElectronicDocument):

    def __init__(self, edoc_list, edoc_name, *args, **kwargs):
        super(NfeEdoc, self).__init__(
            edoc_list, edoc_name,
            **kwargs)
    ...
    def _check(self, *args, **kwargs):
        ...
        for inv in self.edoc_list:
            ...
            if (inv.issuer == '1' or
                    inv.fiscal_type == 'service' or not
                    inv.fiscal_document_electronic):
                return True
