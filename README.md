...
[l10n_br_fiscal](l10n_br_fiscal/) | 12.0.17.4.0 | Brazilian fiscal core module.
...
[l10n_br_nfe_spec](l10n_br_nfe_spec/) | 12.0.3.0.0 | nfe spec
...
[l10n_br_nfse_paulistana](l10n_br_nfse_paulistana/) | 12.0.1.1.0 | NFS-e (Nota Paulistana)
...
[l10n_br_repair](l10n_br_repair/) | 12.0.7.0.0 | Brazilian Localization Repair
...
[l10n_br_sale](l10n_br_sale/) | 12.0.6.1.0 | Brazilian Localization Sale
[l10n_br_sale_stock](l10n_br_sale_stock/) | 12.0.5.4.0 | Brazilian Localization Sales and Warehouse
...
[payment_cielo](payment_cielo/) | 12.0.3.2.1 | Payment Acquirer: Cielo Implementation
[spec_driven_model](spec_driven_model/) | 12.0.1.1.0 | Tools for specifications driven mixins (from xsd for instance)
