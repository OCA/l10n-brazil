...
[l10n_br_nfe](l10n_br_nfe/) | 12.0.10.0.0 |  | Brazilian Eletronic Invoice NF-e .
...
[spec_driven_model](spec_driven_model/) | 12.0.4.0.0 | [![rvalyi](https://github.com/rvalyi.png?size=30px)](https://github.com/rvalyi) | Tools for specifications driven mixins (from xsd for instance)
