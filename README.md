...
--- | --- | --- | ---
[l10n_br_account](l10n_br_account/) | 12.0.14.2.1 |  | Brazilian Localization Account
...
[l10n_br_account_nfe](l10n_br_account_nfe/) | 12.0.1.1.0 |  | Integration between l10n_br_account and l10n_br_nfe
[l10n_br_account_payment_brcobranca](l10n_br_account_payment_brcobranca/) | 12.0.3.2.0 |  | L10n Br Account Payment BRCobranca
[l10n_br_account_payment_order](l10n_br_account_payment_order/) | 12.0.8.2.0 |  | Brazilian Payment Order
...
[l10n_br_contract](l10n_br_contract/) | 12.0.6.1.0 |  | Customization of Contract module for implementations in Brazil.
...
[l10n_br_fiscal](l10n_br_fiscal/) | 12.0.27.2.3 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) | Brazilian fiscal core module.
...
[l10n_br_nfe](l10n_br_nfe/) | 12.0.6.0.0 |  | Brazilian Eletronic Invoice NF-e .
...
[payment_pagseguro](payment_pagseguro/) | 12.0.1.0.2 |  | Payment Acquirer: PagSeguro Implementation
