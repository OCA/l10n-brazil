...
[![Build Status](https://travis-ci.org/OCA/l10n-brazil.svg?branch=14.0)](https://travis-ci.org/OCA/l10n-brazil)
[![Coverage Status](https://coveralls.io/repos/OCA/l10n-brazil/badge.png?branch=14.0)](https://coveralls.io/r/OCA/l10n-brazil?branch=14.0)
...
[l10n_br_base](l10n_br_base/) | 14.0.1.1.0 | Customization of base module for implementations in Brazil.
[l10n_br_coa](l10n_br_coa/) | 14.0.2.0.0 | Base do Planos de Contas brasileiros
[l10n_br_coa_generic](l10n_br_coa_generic/) | 14.0.2.0.0 | Plano de Contas para empresas do Regime normal (Micro e pequenas empresas)
[l10n_br_coa_simple](l10n_br_coa_simple/) | 14.0.2.0.0 | Plano de Contas ITG 1000 para Microempresas e Empresa de Pequeno Porte
[l10n_br_fiscal](l10n_br_fiscal/) | 14.0.2.1.0 | Brazilian fiscal core module.
[l10n_br_nfe_spec](l10n_br_nfe_spec/) | 14.0.1.0.0 | nfe spec
[spec_driven_model](spec_driven_model/) | 14.0.1.0.0 | Tools for specifications driven mixins (from xsd for instance)
