...
--- | --- | --- | ---
[l10n_br_account](l10n_br_account/) | 12.0.11.2.0 |  | Brazilian Localization Account
...
[l10n_br_account_payment_brcobranca](l10n_br_account_payment_brcobranca/) | 12.0.2.0.1 |  | L10n Br Account Payment BRCobranca
[l10n_br_account_payment_order](l10n_br_account_payment_order/) | 12.0.5.0.1 |  | Brazilian Payment Order
[l10n_br_base](l10n_br_base/) | 12.0.4.0.0 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) [![rvalyi](https://github.com/rvalyi.png?size=30px)](https://github.com/rvalyi) | Customization of base module for implementations in Brazil.
...
[l10n_br_contract](l10n_br_contract/) | 12.0.4.1.2 |  | Customization of Contract module for implementations in Brazil.
...
[l10n_br_fiscal](l10n_br_fiscal/) | 12.0.20.3.0 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) | Brazilian fiscal core module.
...
[l10n_br_nfe](l10n_br_nfe/) | 12.0.3.2.1 |  | Brazilian Eletronic Invoice NF-e .
...
[l10n_br_nfse](l10n_br_nfse/) | 12.0.5.4.1 | [![gabrielcardoso21](https://github.com/gabrielcardoso21.png?size=30px)](https://github.com/gabrielcardoso21) [![mileo](https://github.com/mileo.png?size=30px)](https://github.com/mileo) [![luismalta](https://github.com/luismalta.png?size=30px)](https://github.com/luismalta) | NFS-e
...
[l10n_br_nfse_issnet](l10n_br_nfse_issnet/) | 12.0.3.0.1 | [![marcelsavegnago](https://github.com/marcelsavegnago.png?size=30px)](https://github.com/marcelsavegnago) | NFS-e (ISSNet)
