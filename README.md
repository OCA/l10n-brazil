...
--- | --- | --- | ---
[l10n_br_account](l10n_br_account/) | 12.0.8.1.1 |  | Brazilian Localization Account
...
[l10n_br_account_payment_brcobranca](l10n_br_account_payment_brcobranca/) | 12.0.2.0.0 |  | L10n Br Account Payment BRCobranca
[l10n_br_account_payment_order](l10n_br_account_payment_order/) | 12.0.4.0.0 |  | Brazilian Payment Order
...
[l10n_br_coa](l10n_br_coa/) | 12.0.3.1.0 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) [![mileo](https://github.com/mileo.png?size=30px)](https://github.com/mileo) | Base do Planos de Contas brasileiros
...
[l10n_br_coa_simple](l10n_br_coa_simple/) | 12.0.2.2.0 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) | Plano de Contas ITG 1000 para Microempresas e Empresa de Pequeno Porte
...
[l10n_br_fiscal](l10n_br_fiscal/) | 12.0.17.4.1 | [![renatonlima](https://github.com/renatonlima.png?size=30px)](https://github.com/renatonlima) | Brazilian fiscal core module.
...
[l10n_br_nfe](l10n_br_nfe/) | 12.0.3.1.0 |  | Brazilian Eletronic Invoice NF-e .
...
[l10n_br_nfse](l10n_br_nfse/) | 12.0.5.0.0 | [![gabrielcardoso21](https://github.com/gabrielcardoso21.png?size=30px)](https://github.com/gabrielcardoso21) [![mileo](https://github.com/mileo.png?size=30px)](https://github.com/mileo) [![luismalta](https://github.com/luismalta.png?size=30px)](https://github.com/luismalta) | NFS-e
...
[l10n_br_nfse_issnet](l10n_br_nfse_issnet/) | 12.0.3.0.0 | [![marcelsavegnago](https://github.com/marcelsavegnago.png?size=30px)](https://github.com/marcelsavegnago) | NFS-e (ISSNet)
...
[spec_driven_model](spec_driven_model/) | 12.0.1.1.0 | [![rvalyi](https://github.com/rvalyi.png?size=30px)](https://github.com/rvalyi) | Tools for specifications driven mixins (from xsd for instance)
