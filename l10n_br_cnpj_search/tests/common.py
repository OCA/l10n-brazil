...
class TestCnpjCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.mocked_response_serpro_2 = cls.mocked_response_serpro_1.copy()
        cls.mocked_response_serpro_2["socios"] = [
            {
                "tipoSocio": "2",
                "cpf": "07119488449",
        ...
        cls.mocked_response_serpro_3 = cls.mocked_response_serpro_2.copy()
        cls.mocked_response_serpro_3["socios"] = [
            {
                "tipoSocio": "2",
                "nome": "LUIZA ARAUJO DE OLIVEIRA",
                "qualificacao": "49",
