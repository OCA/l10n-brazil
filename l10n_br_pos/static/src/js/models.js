...
//                    }
            ...
            this.models.push({
                model:  'res.partner',
                fields: ['name', 'data_alteracao', 'create_date', 'cnpj_cpf', 'street','city','state_id','country_id','vat','phone','zip','mobile','email','ean13','write_date', 'debit', 'credit', 'credit_limit', 'user_ids', 'l10n_br_city_id'],
