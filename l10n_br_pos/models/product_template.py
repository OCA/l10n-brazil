...
class ProductTemplate(models.Model):
    ...
    def update_pos_fiscal_map(self):
        ...
        for pos_config_id in to_create_ids:
            ...
            pos_fiscal_map_id = self.pos_fiscal_map_ids.create(pos_fiscal_map_id_vals)
    ...
    def create(self, vals_list):
        ...
        for template in templates.filtered(lambda t: t.available_in_pos):
