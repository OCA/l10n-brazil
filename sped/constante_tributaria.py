...
ST_ICMS_COM_REDUCAO = (ST_ICMS_REDUCAO, ST_ICMS_ISENTA_COM_ST, ST_ICMS_ANTERIOR, ST_ICMS_REDUCAO_COM_ST)
ST_ICMS_CALCULA_ST = (ST_ICMS_ST, ST_ICMS_ISENTA_COM_ST, ST_ICMS_REDUCAO_COM_ST, ST_ICMS_OUTRAS)
...
ST_PIS_CALCULA_ALIQUOTA = (ST_PIS_TRIB_NORMAL, ST_PIS_TRIB_DIFERENCIADA, ST_PIS_AQUIS_SEM_CREDITO) + ST_PIS_CALCULA_CREDITO
