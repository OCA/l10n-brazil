...
IDE_INDPRES = [
    ...
    (
        "4",
        (
            "Operação não presencial com NFC-e e NFe com DANFE Simplificado Tipo 2 "
            "(com entrega)"
        ),
    ),
...
class InfNfe(models.AbstractModel):
    ...
    nfe40_infPAA = fields.Many2one(
        comodel_name="nfe.40.infpaa",
...
class Ide(models.AbstractModel):
    ...
    nfe40_serie = fields.Char(
        string="Série do Documento Fiscal", xsd_required=True, xsd_type="TSerie"
    )
    ...
    nfe40_cMunFGIBS = fields.Char(
        ...
        help=(
            ...
            " endereço do destinatário (grupo: E05) nem o local de entrega "
            "(grupo: G01)."
        ),
    )
    ...
    nfe40_tpImp = fields.Selection(
        ...
        help=(
            ...
            "Retrato;\n2 - DANFE Paisagem;\n3 - DANFE Simplificado;\n4 - DANFE"
            " NFC-e;\n5 - DANFE NFC-e em mensagem eletrônica;\n6 - DANFE "
            "Simplificado Tipo 2 (nas condições do Ajuste SINIEF 13/26)."
        ),
    )
    ...
    nfe40_tpEmis = fields.Selection(
        ...
        help=(
            ...
            "Contingência FSDA;\n6 - Contingência SVC - AN;\n7 - Contingência "
            "SVC - RS;\n9 - Contingência off-line da NFC-e e da NF-e com DANFE"
            " Simplificado Tipo 2."
        ),
    )
    ...
    nfe40_indPres = fields.Selection(
        ...
        help=(
            ...
            "no momento da oepração:\n0 - Não se aplica (ex.: Nota Fiscal "
            "complementar ou de ajuste);\n1 - Operação presencial;\n2 - "
            "Operação não presencial, internet;\n3 - Operação não presencial, "
            "teleatendimento;\n4 - Operação não presencial com NFC-e e NFe com"
            " DANFE Simplificado Tipo 2 (com entrega);\n5 - Operação "
    ...
    nfe40_cIndOp = fields.Char(
        string="Código indicador do local da operação",
        help="Código indicador do local da operação de fornecimento",
    )
    ...
    nfe40_procEmi = fields.Selection(
        ...
        help=(
            ...
            "fornecido pelo Fisco;\n4 - emissão de NF-e por Provedor de "
...
class Emit(models.AbstractModel):
    ...
    nfe40_IE = fields.Char(string="Inscrição Estadual do Emitente", xsd_type="TIe")
    ...
    nfe40_ISUFEmit = fields.Char(string="Inscrição do emitente na Suframa")
...
class Icmspart(models.AbstractModel):
    ...
    nfe40_motDesICMS = fields.Selection(
        ...
        help=(
            "Motivo da desoneração do ICMS:9-Outros;10=Deficiente Condutor "
            "(Convênio ICMS 38/12) 11=Deficiente Não Condutor (Convênio ICMS "
            "38/12)"
        ),
    )

    nfe40_indDeduzDeson = fields.Selection(
        ICMSPART_INDDEDUZDESON,
        string="Indica se o valor do ICMS desonerado",
        help=(
            "Indica se o valor do ICMS desonerado (vICMSDeson) deduz do valor "
            "do item (vProd):\n0=Valor do ICMS desonerado (vICMSDeson) não "
            "deduz do valor do item (vProd) / total da NF-e;\n1=Valor do ICMS "
            "desonerado (vICMSDeson) deduz do valor do item (vProd) / total da"
            " NF-e."
        ),
    )
...
class InfPaa(models.AbstractModel):
    "Grupo de Informação do Provedor de Assinatura e Autorização"

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "nfe.40.infpaa"
    _inherit = "spec.mixin.nfe"
    _binding_type = "Tnfe.InfNfe.InfPaa"

    nfe40_CNPJPAA = fields.Char(
    ...
    nfe40_PAASignature = fields.Many2one(
        comodel_name="nfe.40.paasignature",
...
class Paasignature(models.AbstractModel):
    "Assinatura RSA do Emitente para DFe gerados por PAA"

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "nfe.40.paasignature"
    _inherit = "spec.mixin.nfe"
    _binding_type = "Tnfe.InfNfe.InfPaa.Paasignature"

    nfe40_signatureValue = fields.Char(
